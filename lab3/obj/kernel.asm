...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	4d4040ef          	jal	ra,ffffffffc020451e <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	4fa58593          	addi	a1,a1,1274 # ffffffffc0204548 <etext>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	51250513          	addi	a0,a0,1298 # ffffffffc0204568 <etext+0x20>
...
ffffffffc020006e:	732030ef          	jal	ra,ffffffffc02037a0 <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	7bf030ef          	jal	ra,ffffffffc020406c <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	789030ef          	jal	ra,ffffffffc020406c <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	46c50513          	addi	a0,a0,1132 # ffffffffc0204570 <etext+0x28>
void print_kerninfo(void) {
...
ffffffffc020011e:	47650513          	addi	a0,a0,1142 # ffffffffc0204590 <etext+0x48>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	42258593          	addi	a1,a1,1058 # ffffffffc0204548 <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	48250513          	addi	a0,a0,1154 # ffffffffc02045b0 <etext+0x68>
...
ffffffffc0200146:	48e50513          	addi	a0,a0,1166 # ffffffffc02045d0 <etext+0x88>
...
ffffffffc020015a:	49a50513          	addi	a0,a0,1178 # ffffffffc02045f0 <etext+0xa8>
...
ffffffffc0200188:	48c50513          	addi	a0,a0,1164 # ffffffffc0204610 <etext+0xc8>
}
...
ffffffffc0200196:	4ae60613          	addi	a2,a2,1198 # ffffffffc0204640 <etext+0xf8>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	4ba50513          	addi	a0,a0,1210 # ffffffffc0204658 <etext+0x110>
void print_stackframe(void) {
...
ffffffffc02001b2:	4c260613          	addi	a2,a2,1218 # ffffffffc0204670 <etext+0x128>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	4da58593          	addi	a1,a1,1242 # ffffffffc0204690 <etext+0x148>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	4da50513          	addi	a0,a0,1242 # ffffffffc0204698 <etext+0x150>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	4dc60613          	addi	a2,a2,1244 # ffffffffc02046a8 <etext+0x160>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	4fc58593          	addi	a1,a1,1276 # ffffffffc02046d0 <etext+0x188>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	4bc50513          	addi	a0,a0,1212 # ffffffffc0204698 <etext+0x150>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	4f860613          	addi	a2,a2,1272 # ffffffffc02046e0 <etext+0x198>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	51058593          	addi	a1,a1,1296 # ffffffffc0204700 <etext+0x1b8>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	4a050513          	addi	a0,a0,1184 # ffffffffc0204698 <etext+0x150>
...
ffffffffc0200236:	4de50513          	addi	a0,a0,1246 # ffffffffc0204710 <etext+0x1c8>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	4e450513          	addi	a0,a0,1252 # ffffffffc0204738 <etext+0x1f0>
...
ffffffffc020026e:	536c0c13          	addi	s8,s8,1334 # ffffffffc02047a0 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200272:	00006917          	auipc	s2,0x6
ffffffffc0200276:	93e90913          	addi	s2,s2,-1730 # ffffffffc0205bb0 <default_pmm_manager+0x928>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020027a:	00004497          	auipc	s1,0x4
ffffffffc020027e:	4e648493          	addi	s1,s1,1254 # ffffffffc0204760 <etext+0x218>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	4e4b0b13          	addi	s6,s6,1252 # ffffffffc0204768 <etext+0x220>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	404a0a13          	addi	s4,s4,1028 # ffffffffc0204690 <etext+0x148>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	156040ef          	jal	ra,ffffffffc02043ee <readline>
...
ffffffffc02002b2:	4f2d0d13          	addi	s10,s10,1266 # ffffffffc02047a0 <commands>
        argv[argc ++] = buf;
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	22e040ef          	jal	ra,ffffffffc02044ea <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	21a040ef          	jal	ra,ffffffffc02044ea <strcmp>
...
ffffffffc020030e:	1fa040ef          	jal	ra,ffffffffc0204508 <strchr>
...
ffffffffc020034c:	1bc040ef          	jal	ra,ffffffffc0204508 <strchr>
...
ffffffffc020036a:	42250513          	addi	a0,a0,1058 # ffffffffc0204788 <etext+0x240>
...
ffffffffc02003a6:	44650513          	addi	a0,a0,1094 # ffffffffc02047e8 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02003bc:	34850513          	addi	a0,a0,840 # ffffffffc0205700 <default_pmm_manager+0x478>
...
ffffffffc02003fa:	41250513          	addi	a0,a0,1042 # ffffffffc0204808 <commands+0x68>
    ticks = 0;
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	078040ef          	jal	ra,ffffffffc0204530 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	054040ef          	jal	ra,ffffffffc0204530 <memcpy>
    return 0;
}
...
ffffffffc0200528:	30450513          	addi	a0,a0,772 # ffffffffc0204828 <commands+0x88>
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	0310306f          	j	ffffffffc0203d78 <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc020054c:	00004617          	auipc	a2,0x4
ffffffffc0200550:	2fc60613          	addi	a2,a2,764 # ffffffffc0204848 <commands+0xa8>
ffffffffc0200554:	07800593          	li	a1,120
ffffffffc0200558:	00004517          	auipc	a0,0x4
ffffffffc020055c:	30850513          	addi	a0,a0,776 # ffffffffc0204860 <commands+0xc0>
...
ffffffffc020058e:	2ee50513          	addi	a0,a0,750 # ffffffffc0204878 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200746:	41e50513          	addi	a0,a0,1054 # ffffffffc0204b60 <commands+0x3c0>
}
...
ffffffffc020075a:	42250513          	addi	a0,a0,1058 # ffffffffc0204b78 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200772:	42250513          	addi	a0,a0,1058 # ffffffffc0204b90 <commands+0x3f0>
ffffffffc0200776:	945ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
ffffffffc020077a:	10843583          	ld	a1,264(s0)
ffffffffc020077e:	00004517          	auipc	a0,0x4
ffffffffc0200782:	42a50513          	addi	a0,a0,1066 # ffffffffc0204ba8 <commands+0x408>
ffffffffc0200786:	935ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  badvaddr 0x%08x\n", tf->badvaddr);
ffffffffc020078a:	11043583          	ld	a1,272(s0)
ffffffffc020078e:	00004517          	auipc	a0,0x4
ffffffffc0200792:	43250513          	addi	a0,a0,1074 # ffffffffc0204bc0 <commands+0x420>
...
ffffffffc02007a6:	43650513          	addi	a0,a0,1078 # ffffffffc0204bd8 <commands+0x438>
}
...
ffffffffc02007c2:	4e270713          	addi	a4,a4,1250 # ffffffffc0204ca0 <commands+0x500>
...
ffffffffc02007d4:	48050513          	addi	a0,a0,1152 # ffffffffc0204c50 <commands+0x4b0>
ffffffffc02007d8:	8e3ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007dc:	00004517          	auipc	a0,0x4
ffffffffc02007e0:	45450513          	addi	a0,a0,1108 # ffffffffc0204c30 <commands+0x490>
ffffffffc02007e4:	8d7ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007e8:	00004517          	auipc	a0,0x4
ffffffffc02007ec:	40850513          	addi	a0,a0,1032 # ffffffffc0204bf0 <commands+0x450>
ffffffffc02007f0:	8cbff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02007f4:	00004517          	auipc	a0,0x4
ffffffffc02007f8:	41c50513          	addi	a0,a0,1052 # ffffffffc0204c10 <commands+0x470>
...
ffffffffc020082a:	45a50513          	addi	a0,a0,1114 # ffffffffc0204c80 <commands+0x4e0>
...
ffffffffc020083e:	43650513          	addi	a0,a0,1078 # ffffffffc0204c70 <commands+0x4d0>
}
...
ffffffffc0200860:	62c70713          	addi	a4,a4,1580 # ffffffffc0204e88 <commands+0x6e8>
...
ffffffffc0200872:	60250513          	addi	a0,a0,1538 # ffffffffc0204e70 <commands+0x6d0>
...
ffffffffc0200894:	44050513          	addi	a0,a0,1088 # ffffffffc0204cd0 <commands+0x530>
}
...
ffffffffc02008a8:	44c50513          	addi	a0,a0,1100 # ffffffffc0204cf0 <commands+0x550>
ffffffffc02008ac:	b7f5                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008ae:	00004517          	auipc	a0,0x4
ffffffffc02008b2:	46250513          	addi	a0,a0,1122 # ffffffffc0204d10 <commands+0x570>
ffffffffc02008b6:	b7cd                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008b8:	00004517          	auipc	a0,0x4
ffffffffc02008bc:	47050513          	addi	a0,a0,1136 # ffffffffc0204d28 <commands+0x588>
ffffffffc02008c0:	bfe1                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c2:	00004517          	auipc	a0,0x4
ffffffffc02008c6:	47650513          	addi	a0,a0,1142 # ffffffffc0204d38 <commands+0x598>
ffffffffc02008ca:	b7f9                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008cc:	00004517          	auipc	a0,0x4
ffffffffc02008d0:	48c50513          	addi	a0,a0,1164 # ffffffffc0204d58 <commands+0x5b8>
...
ffffffffc02008ee:	48660613          	addi	a2,a2,1158 # ffffffffc0204d70 <commands+0x5d0>
ffffffffc02008f2:	0ca00593          	li	a1,202
ffffffffc02008f6:	00004517          	auipc	a0,0x4
ffffffffc02008fa:	f6a50513          	addi	a0,a0,-150 # ffffffffc0204860 <commands+0xc0>
ffffffffc02008fe:	a77ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200902:	00004517          	auipc	a0,0x4
ffffffffc0200906:	48e50513          	addi	a0,a0,1166 # ffffffffc0204d90 <commands+0x5f0>
ffffffffc020090a:	b779                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc020090c:	00004517          	auipc	a0,0x4
ffffffffc0200910:	49c50513          	addi	a0,a0,1180 # ffffffffc0204da8 <commands+0x608>
...
ffffffffc0200998:	3dc60613          	addi	a2,a2,988 # ffffffffc0204d70 <commands+0x5d0>
ffffffffc020099c:	0ea00593          	li	a1,234
ffffffffc02009a0:	00004517          	auipc	a0,0x4
ffffffffc02009a4:	ec050513          	addi	a0,a0,-320 # ffffffffc0204860 <commands+0xc0>
...
ffffffffc02009c4:	3b060613          	addi	a2,a2,944 # ffffffffc0204d70 <commands+0x5d0>
ffffffffc02009c8:	0f100593          	li	a1,241
ffffffffc02009cc:	00004517          	auipc	a0,0x4
ffffffffc02009d0:	e9450513          	addi	a0,a0,-364 # ffffffffc0204860 <commands+0xc0>
...
ffffffffc0200b6e:	7fe5b583          	ld	a1,2046(a1) # ffffffffc0206368 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00005617          	auipc	a2,0x5
ffffffffc0200b7a:	7fa63603          	ld	a2,2042(a2) # ffffffffc0206370 <nbase>
...
ffffffffc0200dc6:	10668693          	addi	a3,a3,262 # ffffffffc0204ec8 <commands+0x728>
ffffffffc0200dca:	00004617          	auipc	a2,0x4
ffffffffc0200dce:	10e60613          	addi	a2,a2,270 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200dd2:	0f000593          	li	a1,240
ffffffffc0200dd6:	00004517          	auipc	a0,0x4
ffffffffc0200dda:	11a50513          	addi	a0,a0,282 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200dde:	d96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200de2:	00004697          	auipc	a3,0x4
ffffffffc0200de6:	1a668693          	addi	a3,a3,422 # ffffffffc0204f88 <commands+0x7e8>
ffffffffc0200dea:	00004617          	auipc	a2,0x4
ffffffffc0200dee:	0ee60613          	addi	a2,a2,238 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200df2:	0bd00593          	li	a1,189
ffffffffc0200df6:	00004517          	auipc	a0,0x4
ffffffffc0200dfa:	0fa50513          	addi	a0,a0,250 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200dfe:	d76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e02:	00004697          	auipc	a3,0x4
ffffffffc0200e06:	1ae68693          	addi	a3,a3,430 # ffffffffc0204fb0 <commands+0x810>
ffffffffc0200e0a:	00004617          	auipc	a2,0x4
ffffffffc0200e0e:	0ce60613          	addi	a2,a2,206 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200e12:	0be00593          	li	a1,190
ffffffffc0200e16:	00004517          	auipc	a0,0x4
ffffffffc0200e1a:	0da50513          	addi	a0,a0,218 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200e1e:	d56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e22:	00004697          	auipc	a3,0x4
ffffffffc0200e26:	1ce68693          	addi	a3,a3,462 # ffffffffc0204ff0 <commands+0x850>
ffffffffc0200e2a:	00004617          	auipc	a2,0x4
ffffffffc0200e2e:	0ae60613          	addi	a2,a2,174 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200e32:	0c000593          	li	a1,192
ffffffffc0200e36:	00004517          	auipc	a0,0x4
ffffffffc0200e3a:	0ba50513          	addi	a0,a0,186 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200e3e:	d36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200e42:	00004697          	auipc	a3,0x4
ffffffffc0200e46:	23668693          	addi	a3,a3,566 # ffffffffc0205078 <commands+0x8d8>
ffffffffc0200e4a:	00004617          	auipc	a2,0x4
ffffffffc0200e4e:	08e60613          	addi	a2,a2,142 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200e52:	0d900593          	li	a1,217
ffffffffc0200e56:	00004517          	auipc	a0,0x4
ffffffffc0200e5a:	09a50513          	addi	a0,a0,154 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200e5e:	d16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200e62:	00004697          	auipc	a3,0x4
ffffffffc0200e66:	0c668693          	addi	a3,a3,198 # ffffffffc0204f28 <commands+0x788>
ffffffffc0200e6a:	00004617          	auipc	a2,0x4
ffffffffc0200e6e:	06e60613          	addi	a2,a2,110 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200e72:	0d200593          	li	a1,210
ffffffffc0200e76:	00004517          	auipc	a0,0x4
ffffffffc0200e7a:	07a50513          	addi	a0,a0,122 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200e7e:	cf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200e82:	00004697          	auipc	a3,0x4
ffffffffc0200e86:	1e668693          	addi	a3,a3,486 # ffffffffc0205068 <commands+0x8c8>
ffffffffc0200e8a:	00004617          	auipc	a2,0x4
ffffffffc0200e8e:	04e60613          	addi	a2,a2,78 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200e92:	0d000593          	li	a1,208
ffffffffc0200e96:	00004517          	auipc	a0,0x4
ffffffffc0200e9a:	05a50513          	addi	a0,a0,90 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200e9e:	cd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ea2:	00004697          	auipc	a3,0x4
ffffffffc0200ea6:	1ae68693          	addi	a3,a3,430 # ffffffffc0205050 <commands+0x8b0>
ffffffffc0200eaa:	00004617          	auipc	a2,0x4
ffffffffc0200eae:	02e60613          	addi	a2,a2,46 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200eb2:	0cb00593          	li	a1,203
ffffffffc0200eb6:	00004517          	auipc	a0,0x4
ffffffffc0200eba:	03a50513          	addi	a0,a0,58 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200ebe:	cb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200ec2:	00004697          	auipc	a3,0x4
ffffffffc0200ec6:	16e68693          	addi	a3,a3,366 # ffffffffc0205030 <commands+0x890>
ffffffffc0200eca:	00004617          	auipc	a2,0x4
ffffffffc0200ece:	00e60613          	addi	a2,a2,14 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200ed2:	0c200593          	li	a1,194
ffffffffc0200ed6:	00004517          	auipc	a0,0x4
ffffffffc0200eda:	01a50513          	addi	a0,a0,26 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200ede:	c96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200ee2:	00004697          	auipc	a3,0x4
ffffffffc0200ee6:	1de68693          	addi	a3,a3,478 # ffffffffc02050c0 <commands+0x920>
ffffffffc0200eea:	00004617          	auipc	a2,0x4
ffffffffc0200eee:	fee60613          	addi	a2,a2,-18 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200ef2:	0f800593          	li	a1,248
ffffffffc0200ef6:	00004517          	auipc	a0,0x4
ffffffffc0200efa:	ffa50513          	addi	a0,a0,-6 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200efe:	c76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f02:	00004697          	auipc	a3,0x4
ffffffffc0200f06:	1ae68693          	addi	a3,a3,430 # ffffffffc02050b0 <commands+0x910>
ffffffffc0200f0a:	00004617          	auipc	a2,0x4
ffffffffc0200f0e:	fce60613          	addi	a2,a2,-50 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200f12:	0df00593          	li	a1,223
ffffffffc0200f16:	00004517          	auipc	a0,0x4
ffffffffc0200f1a:	fda50513          	addi	a0,a0,-38 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200f1e:	c56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f22:	00004697          	auipc	a3,0x4
ffffffffc0200f26:	12e68693          	addi	a3,a3,302 # ffffffffc0205050 <commands+0x8b0>
ffffffffc0200f2a:	00004617          	auipc	a2,0x4
ffffffffc0200f2e:	fae60613          	addi	a2,a2,-82 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200f32:	0dd00593          	li	a1,221
ffffffffc0200f36:	00004517          	auipc	a0,0x4
ffffffffc0200f3a:	fba50513          	addi	a0,a0,-70 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200f3e:	c36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f42:	00004697          	auipc	a3,0x4
ffffffffc0200f46:	14e68693          	addi	a3,a3,334 # ffffffffc0205090 <commands+0x8f0>
ffffffffc0200f4a:	00004617          	auipc	a2,0x4
ffffffffc0200f4e:	f8e60613          	addi	a2,a2,-114 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200f52:	0dc00593          	li	a1,220
ffffffffc0200f56:	00004517          	auipc	a0,0x4
ffffffffc0200f5a:	f9a50513          	addi	a0,a0,-102 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200f5e:	c16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f62:	00004697          	auipc	a3,0x4
ffffffffc0200f66:	fc668693          	addi	a3,a3,-58 # ffffffffc0204f28 <commands+0x788>
ffffffffc0200f6a:	00004617          	auipc	a2,0x4
ffffffffc0200f6e:	f6e60613          	addi	a2,a2,-146 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200f72:	0b900593          	li	a1,185
ffffffffc0200f76:	00004517          	auipc	a0,0x4
ffffffffc0200f7a:	f7a50513          	addi	a0,a0,-134 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200f7e:	bf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f82:	00004697          	auipc	a3,0x4
ffffffffc0200f86:	0ce68693          	addi	a3,a3,206 # ffffffffc0205050 <commands+0x8b0>
ffffffffc0200f8a:	00004617          	auipc	a2,0x4
ffffffffc0200f8e:	f4e60613          	addi	a2,a2,-178 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200f92:	0d600593          	li	a1,214
ffffffffc0200f96:	00004517          	auipc	a0,0x4
ffffffffc0200f9a:	f5a50513          	addi	a0,a0,-166 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200f9e:	bd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fa2:	00004697          	auipc	a3,0x4
ffffffffc0200fa6:	fc668693          	addi	a3,a3,-58 # ffffffffc0204f68 <commands+0x7c8>
ffffffffc0200faa:	00004617          	auipc	a2,0x4
ffffffffc0200fae:	f2e60613          	addi	a2,a2,-210 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200fb2:	0d400593          	li	a1,212
ffffffffc0200fb6:	00004517          	auipc	a0,0x4
ffffffffc0200fba:	f3a50513          	addi	a0,a0,-198 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200fbe:	bb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200fc2:	00004697          	auipc	a3,0x4
ffffffffc0200fc6:	f8668693          	addi	a3,a3,-122 # ffffffffc0204f48 <commands+0x7a8>
ffffffffc0200fca:	00004617          	auipc	a2,0x4
ffffffffc0200fce:	f0e60613          	addi	a2,a2,-242 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200fd2:	0d300593          	li	a1,211
ffffffffc0200fd6:	00004517          	auipc	a0,0x4
ffffffffc0200fda:	f1a50513          	addi	a0,a0,-230 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200fde:	b96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fe2:	00004697          	auipc	a3,0x4
ffffffffc0200fe6:	f8668693          	addi	a3,a3,-122 # ffffffffc0204f68 <commands+0x7c8>
ffffffffc0200fea:	00004617          	auipc	a2,0x4
ffffffffc0200fee:	eee60613          	addi	a2,a2,-274 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0200ff2:	0bb00593          	li	a1,187
ffffffffc0200ff6:	00004517          	auipc	a0,0x4
ffffffffc0200ffa:	efa50513          	addi	a0,a0,-262 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0200ffe:	b76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201002:	00004697          	auipc	a3,0x4
ffffffffc0201006:	20e68693          	addi	a3,a3,526 # ffffffffc0205210 <commands+0xa70>
ffffffffc020100a:	00004617          	auipc	a2,0x4
ffffffffc020100e:	ece60613          	addi	a2,a2,-306 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201012:	12500593          	li	a1,293
ffffffffc0201016:	00004517          	auipc	a0,0x4
ffffffffc020101a:	eda50513          	addi	a0,a0,-294 # ffffffffc0204ef0 <commands+0x750>
ffffffffc020101e:	b56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201022:	00004697          	auipc	a3,0x4
ffffffffc0201026:	08e68693          	addi	a3,a3,142 # ffffffffc02050b0 <commands+0x910>
ffffffffc020102a:	00004617          	auipc	a2,0x4
ffffffffc020102e:	eae60613          	addi	a2,a2,-338 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201032:	11a00593          	li	a1,282
ffffffffc0201036:	00004517          	auipc	a0,0x4
ffffffffc020103a:	eba50513          	addi	a0,a0,-326 # ffffffffc0204ef0 <commands+0x750>
ffffffffc020103e:	b36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201042:	00004697          	auipc	a3,0x4
ffffffffc0201046:	00e68693          	addi	a3,a3,14 # ffffffffc0205050 <commands+0x8b0>
ffffffffc020104a:	00004617          	auipc	a2,0x4
ffffffffc020104e:	e8e60613          	addi	a2,a2,-370 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201052:	11800593          	li	a1,280
ffffffffc0201056:	00004517          	auipc	a0,0x4
ffffffffc020105a:	e9a50513          	addi	a0,a0,-358 # ffffffffc0204ef0 <commands+0x750>
ffffffffc020105e:	b16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201062:	00004697          	auipc	a3,0x4
ffffffffc0201066:	fae68693          	addi	a3,a3,-82 # ffffffffc0205010 <commands+0x870>
ffffffffc020106a:	00004617          	auipc	a2,0x4
ffffffffc020106e:	e6e60613          	addi	a2,a2,-402 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201072:	0c100593          	li	a1,193
ffffffffc0201076:	00004517          	auipc	a0,0x4
ffffffffc020107a:	e7a50513          	addi	a0,a0,-390 # ffffffffc0204ef0 <commands+0x750>
ffffffffc020107e:	af6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201082:	00004697          	auipc	a3,0x4
ffffffffc0201086:	14e68693          	addi	a3,a3,334 # ffffffffc02051d0 <commands+0xa30>
ffffffffc020108a:	00004617          	auipc	a2,0x4
ffffffffc020108e:	e4e60613          	addi	a2,a2,-434 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201092:	11200593          	li	a1,274
ffffffffc0201096:	00004517          	auipc	a0,0x4
ffffffffc020109a:	e5a50513          	addi	a0,a0,-422 # ffffffffc0204ef0 <commands+0x750>
ffffffffc020109e:	ad6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02010a2:	00004697          	auipc	a3,0x4
ffffffffc02010a6:	10e68693          	addi	a3,a3,270 # ffffffffc02051b0 <commands+0xa10>
ffffffffc02010aa:	00004617          	auipc	a2,0x4
ffffffffc02010ae:	e2e60613          	addi	a2,a2,-466 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02010b2:	11000593          	li	a1,272
ffffffffc02010b6:	00004517          	auipc	a0,0x4
ffffffffc02010ba:	e3a50513          	addi	a0,a0,-454 # ffffffffc0204ef0 <commands+0x750>
ffffffffc02010be:	ab6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02010c2:	00004697          	auipc	a3,0x4
ffffffffc02010c6:	0c668693          	addi	a3,a3,198 # ffffffffc0205188 <commands+0x9e8>
ffffffffc02010ca:	00004617          	auipc	a2,0x4
ffffffffc02010ce:	e0e60613          	addi	a2,a2,-498 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02010d2:	10e00593          	li	a1,270
ffffffffc02010d6:	00004517          	auipc	a0,0x4
ffffffffc02010da:	e1a50513          	addi	a0,a0,-486 # ffffffffc0204ef0 <commands+0x750>
ffffffffc02010de:	a96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02010e2:	00004697          	auipc	a3,0x4
ffffffffc02010e6:	07e68693          	addi	a3,a3,126 # ffffffffc0205160 <commands+0x9c0>
ffffffffc02010ea:	00004617          	auipc	a2,0x4
ffffffffc02010ee:	dee60613          	addi	a2,a2,-530 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02010f2:	10d00593          	li	a1,269
ffffffffc02010f6:	00004517          	auipc	a0,0x4
ffffffffc02010fa:	dfa50513          	addi	a0,a0,-518 # ffffffffc0204ef0 <commands+0x750>
ffffffffc02010fe:	a76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201102:	00004697          	auipc	a3,0x4
ffffffffc0201106:	04e68693          	addi	a3,a3,78 # ffffffffc0205150 <commands+0x9b0>
ffffffffc020110a:	00004617          	auipc	a2,0x4
ffffffffc020110e:	dce60613          	addi	a2,a2,-562 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201112:	10800593          	li	a1,264
ffffffffc0201116:	00004517          	auipc	a0,0x4
ffffffffc020111a:	dda50513          	addi	a0,a0,-550 # ffffffffc0204ef0 <commands+0x750>
ffffffffc020111e:	a56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201122:	00004697          	auipc	a3,0x4
ffffffffc0201126:	f2e68693          	addi	a3,a3,-210 # ffffffffc0205050 <commands+0x8b0>
ffffffffc020112a:	00004617          	auipc	a2,0x4
ffffffffc020112e:	dae60613          	addi	a2,a2,-594 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201132:	10700593          	li	a1,263
ffffffffc0201136:	00004517          	auipc	a0,0x4
ffffffffc020113a:	dba50513          	addi	a0,a0,-582 # ffffffffc0204ef0 <commands+0x750>
ffffffffc020113e:	a36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201142:	00004697          	auipc	a3,0x4
ffffffffc0201146:	fee68693          	addi	a3,a3,-18 # ffffffffc0205130 <commands+0x990>
ffffffffc020114a:	00004617          	auipc	a2,0x4
ffffffffc020114e:	d8e60613          	addi	a2,a2,-626 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201152:	10600593          	li	a1,262
ffffffffc0201156:	00004517          	auipc	a0,0x4
ffffffffc020115a:	d9a50513          	addi	a0,a0,-614 # ffffffffc0204ef0 <commands+0x750>
ffffffffc020115e:	a16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201162:	00004697          	auipc	a3,0x4
ffffffffc0201166:	f9e68693          	addi	a3,a3,-98 # ffffffffc0205100 <commands+0x960>
ffffffffc020116a:	00004617          	auipc	a2,0x4
ffffffffc020116e:	d6e60613          	addi	a2,a2,-658 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201172:	10500593          	li	a1,261
ffffffffc0201176:	00004517          	auipc	a0,0x4
ffffffffc020117a:	d7a50513          	addi	a0,a0,-646 # ffffffffc0204ef0 <commands+0x750>
ffffffffc020117e:	9f6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201182:	00004697          	auipc	a3,0x4
ffffffffc0201186:	f6668693          	addi	a3,a3,-154 # ffffffffc02050e8 <commands+0x948>
ffffffffc020118a:	00004617          	auipc	a2,0x4
ffffffffc020118e:	d4e60613          	addi	a2,a2,-690 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201192:	10400593          	li	a1,260
ffffffffc0201196:	00004517          	auipc	a0,0x4
ffffffffc020119a:	d5a50513          	addi	a0,a0,-678 # ffffffffc0204ef0 <commands+0x750>
ffffffffc020119e:	9d6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011a2:	00004697          	auipc	a3,0x4
ffffffffc02011a6:	eae68693          	addi	a3,a3,-338 # ffffffffc0205050 <commands+0x8b0>
ffffffffc02011aa:	00004617          	auipc	a2,0x4
ffffffffc02011ae:	d2e60613          	addi	a2,a2,-722 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02011b2:	0fe00593          	li	a1,254
ffffffffc02011b6:	00004517          	auipc	a0,0x4
ffffffffc02011ba:	d3a50513          	addi	a0,a0,-710 # ffffffffc0204ef0 <commands+0x750>
ffffffffc02011be:	9b6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc02011c2:	00004697          	auipc	a3,0x4
ffffffffc02011c6:	f0e68693          	addi	a3,a3,-242 # ffffffffc02050d0 <commands+0x930>
ffffffffc02011ca:	00004617          	auipc	a2,0x4
ffffffffc02011ce:	d0e60613          	addi	a2,a2,-754 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02011d2:	0f900593          	li	a1,249
ffffffffc02011d6:	00004517          	auipc	a0,0x4
ffffffffc02011da:	d1a50513          	addi	a0,a0,-742 # ffffffffc0204ef0 <commands+0x750>
ffffffffc02011de:	996ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02011e2:	00004697          	auipc	a3,0x4
ffffffffc02011e6:	00e68693          	addi	a3,a3,14 # ffffffffc02051f0 <commands+0xa50>
ffffffffc02011ea:	00004617          	auipc	a2,0x4
ffffffffc02011ee:	cee60613          	addi	a2,a2,-786 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02011f2:	11700593          	li	a1,279
ffffffffc02011f6:	00004517          	auipc	a0,0x4
ffffffffc02011fa:	cfa50513          	addi	a0,a0,-774 # ffffffffc0204ef0 <commands+0x750>
ffffffffc02011fe:	976ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201202:	00004697          	auipc	a3,0x4
ffffffffc0201206:	01e68693          	addi	a3,a3,30 # ffffffffc0205220 <commands+0xa80>
ffffffffc020120a:	00004617          	auipc	a2,0x4
ffffffffc020120e:	cce60613          	addi	a2,a2,-818 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201212:	12600593          	li	a1,294
ffffffffc0201216:	00004517          	auipc	a0,0x4
ffffffffc020121a:	cda50513          	addi	a0,a0,-806 # ffffffffc0204ef0 <commands+0x750>
ffffffffc020121e:	956ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201222:	00004697          	auipc	a3,0x4
ffffffffc0201226:	ce668693          	addi	a3,a3,-794 # ffffffffc0204f08 <commands+0x768>
ffffffffc020122a:	00004617          	auipc	a2,0x4
ffffffffc020122e:	cae60613          	addi	a2,a2,-850 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201232:	0f300593          	li	a1,243
ffffffffc0201236:	00004517          	auipc	a0,0x4
ffffffffc020123a:	cba50513          	addi	a0,a0,-838 # ffffffffc0204ef0 <commands+0x750>
ffffffffc020123e:	936ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201242:	00004697          	auipc	a3,0x4
ffffffffc0201246:	d0668693          	addi	a3,a3,-762 # ffffffffc0204f48 <commands+0x7a8>
ffffffffc020124a:	00004617          	auipc	a2,0x4
ffffffffc020124e:	c8e60613          	addi	a2,a2,-882 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201252:	0ba00593          	li	a1,186
ffffffffc0201256:	00004517          	auipc	a0,0x4
ffffffffc020125a:	c9a50513          	addi	a0,a0,-870 # ffffffffc0204ef0 <commands+0x750>
...
ffffffffc020139e:	e9e68693          	addi	a3,a3,-354 # ffffffffc0205238 <commands+0xa98>
ffffffffc02013a2:	00004617          	auipc	a2,0x4
ffffffffc02013a6:	b3660613          	addi	a2,a2,-1226 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02013aa:	08300593          	li	a1,131
ffffffffc02013ae:	00004517          	auipc	a0,0x4
ffffffffc02013b2:	b4250513          	addi	a0,a0,-1214 # ffffffffc0204ef0 <commands+0x750>
ffffffffc02013b6:	fbffe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc02013ba:	00004697          	auipc	a3,0x4
ffffffffc02013be:	e7668693          	addi	a3,a3,-394 # ffffffffc0205230 <commands+0xa90>
ffffffffc02013c2:	00004617          	auipc	a2,0x4
ffffffffc02013c6:	b1660613          	addi	a2,a2,-1258 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02013ca:	08000593          	li	a1,128
ffffffffc02013ce:	00004517          	auipc	a0,0x4
ffffffffc02013d2:	b2250513          	addi	a0,a0,-1246 # ffffffffc0204ef0 <commands+0x750>
...
ffffffffc0201476:	dbe68693          	addi	a3,a3,-578 # ffffffffc0205230 <commands+0xa90>
ffffffffc020147a:	00004617          	auipc	a2,0x4
ffffffffc020147e:	a5e60613          	addi	a2,a2,-1442 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201482:	06200593          	li	a1,98
ffffffffc0201486:	00004517          	auipc	a0,0x4
ffffffffc020148a:	a6a50513          	addi	a0,a0,-1430 # ffffffffc0204ef0 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020154c:	d1868693          	addi	a3,a3,-744 # ffffffffc0205260 <commands+0xac0>
ffffffffc0201550:	00004617          	auipc	a2,0x4
ffffffffc0201554:	98860613          	addi	a2,a2,-1656 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201558:	04900593          	li	a1,73
ffffffffc020155c:	00004517          	auipc	a0,0x4
ffffffffc0201560:	99450513          	addi	a0,a0,-1644 # ffffffffc0204ef0 <commands+0x750>
ffffffffc0201564:	e11fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201568:	00004697          	auipc	a3,0x4
ffffffffc020156c:	cc868693          	addi	a3,a3,-824 # ffffffffc0205230 <commands+0xa90>
ffffffffc0201570:	00004617          	auipc	a2,0x4
ffffffffc0201574:	96860613          	addi	a2,a2,-1688 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0201578:	04600593          	li	a1,70
ffffffffc020157c:	00004517          	auipc	a0,0x4
ffffffffc0201580:	97450513          	addi	a0,a0,-1676 # ffffffffc0204ef0 <commands+0x750>
...
ffffffffc020158e:	d3660613          	addi	a2,a2,-714 # ffffffffc02052c0 <default_pmm_manager+0x38>
ffffffffc0201592:	06500593          	li	a1,101
ffffffffc0201596:	00004517          	auipc	a0,0x4
ffffffffc020159a:	d4a50513          	addi	a0,a0,-694 # ffffffffc02052e0 <default_pmm_manager+0x58>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02015aa:	d4a60613          	addi	a2,a2,-694 # ffffffffc02052f0 <default_pmm_manager+0x68>
ffffffffc02015ae:	07000593          	li	a1,112
ffffffffc02015b2:	00004517          	auipc	a0,0x4
ffffffffc02015b6:	d2e50513          	addi	a0,a0,-722 # ffffffffc02052e0 <default_pmm_manager+0x58>
static inline struct Page *pte2page(pte_t pte) {
...
ffffffffc0201722:	c4ab3b03          	ld	s6,-950(s6) # ffffffffc0206368 <error_string+0x38>
...
ffffffffc0201760:	5bf020ef          	jal	ra,ffffffffc020451e <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02017d0:	b9cb3b03          	ld	s6,-1124(s6) # ffffffffc0206368 <error_string+0x38>
...
ffffffffc0201802:	51d020ef          	jal	ra,ffffffffc020451e <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201862:	aba60613          	addi	a2,a2,-1350 # ffffffffc0205318 <default_pmm_manager+0x90>
ffffffffc0201866:	10200593          	li	a1,258
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	ad650513          	addi	a0,a0,-1322 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0201872:	b03fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201876:	00004617          	auipc	a2,0x4
ffffffffc020187a:	aa260613          	addi	a2,a2,-1374 # ffffffffc0205318 <default_pmm_manager+0x90>
ffffffffc020187e:	10f00593          	li	a1,271
ffffffffc0201882:	00004517          	auipc	a0,0x4
ffffffffc0201886:	abe50513          	addi	a0,a0,-1346 # ffffffffc0205340 <default_pmm_manager+0xb8>
...
ffffffffc0201894:	a8860613          	addi	a2,a2,-1400 # ffffffffc0205318 <default_pmm_manager+0x90>
ffffffffc0201898:	10b00593          	li	a1,267
ffffffffc020189c:	00004517          	auipc	a0,0x4
ffffffffc02018a0:	aa450513          	addi	a0,a0,-1372 # ffffffffc0205340 <default_pmm_manager+0xb8>
...
ffffffffc02018ae:	a6e60613          	addi	a2,a2,-1426 # ffffffffc0205318 <default_pmm_manager+0x90>
ffffffffc02018b2:	0ff00593          	li	a1,255
ffffffffc02018b6:	00004517          	auipc	a0,0x4
ffffffffc02018ba:	a8a50513          	addi	a0,a0,-1398 # ffffffffc0205340 <default_pmm_manager+0xb8>
...
ffffffffc02019f8:	97443403          	ld	s0,-1676(s0) # ffffffffc0206368 <error_string+0x38>
...
ffffffffc0201aba:	7d278793          	addi	a5,a5,2002 # ffffffffc0205288 <default_pmm_manager>
...
ffffffffc0201ac8:	88c50513          	addi	a0,a0,-1908 # ffffffffc0205350 <default_pmm_manager+0xc8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201b24:	84850513          	addi	a0,a0,-1976 # ffffffffc0205368 <default_pmm_manager+0xe0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b34:	86850513          	addi	a0,a0,-1944 # ffffffffc0205398 <default_pmm_manager+0x110>
...
ffffffffc0201b4e:	86650513          	addi	a0,a0,-1946 # ffffffffc02053b0 <default_pmm_manager+0x128>
...
ffffffffc0201bda:	82a50513          	addi	a0,a0,-2006 # ffffffffc0205400 <default_pmm_manager+0x178>
...
ffffffffc0201dfe:	56ecbc83          	ld	s9,1390(s9) # ffffffffc0206368 <error_string+0x38>
...
ffffffffc0201ea2:	84a50513          	addi	a0,a0,-1974 # ffffffffc02056e8 <default_pmm_manager+0x460>
...
ffffffffc0201f58:	8cc58593          	addi	a1,a1,-1844 # ffffffffc0205820 <default_pmm_manager+0x598>
ffffffffc0201f5c:	10000513          	li	a0,256
ffffffffc0201f60:	578020ef          	jal	ra,ffffffffc02044d8 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	57e020ef          	jal	ra,ffffffffc02044ea <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	4fc020ef          	jal	ra,ffffffffc02044a2 <strlen>
...
ffffffffc020209c:	80050513          	addi	a0,a0,-2048 # ffffffffc0205898 <default_pmm_manager+0x610>
}
...
ffffffffc02021a2:	5aa68693          	addi	a3,a3,1450 # ffffffffc0205748 <default_pmm_manager+0x4c0>
ffffffffc02021a6:	00003617          	auipc	a2,0x3
ffffffffc02021aa:	d3260613          	addi	a2,a2,-718 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02021ae:	1ce00593          	li	a1,462
ffffffffc02021b2:	00003517          	auipc	a0,0x3
ffffffffc02021b6:	18e50513          	addi	a0,a0,398 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02021ba:	9bafe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02021be:	00003697          	auipc	a3,0x3
ffffffffc02021c2:	54a68693          	addi	a3,a3,1354 # ffffffffc0205708 <default_pmm_manager+0x480>
ffffffffc02021c6:	00003617          	auipc	a2,0x3
ffffffffc02021ca:	d1260613          	addi	a2,a2,-750 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02021ce:	1cd00593          	li	a1,461
ffffffffc02021d2:	00003517          	auipc	a0,0x3
ffffffffc02021d6:	16e50513          	addi	a0,a0,366 # ffffffffc0205340 <default_pmm_manager+0xb8>
...
ffffffffc02021e4:	13860613          	addi	a2,a2,312 # ffffffffc0205318 <default_pmm_manager+0x90>
ffffffffc02021e8:	1cd00593          	li	a1,461
ffffffffc02021ec:	00003517          	auipc	a0,0x3
ffffffffc02021f0:	15450513          	addi	a0,a0,340 # ffffffffc0205340 <default_pmm_manager+0xb8>
...
ffffffffc0202200:	1dc60613          	addi	a2,a2,476 # ffffffffc02053d8 <default_pmm_manager+0x150>
ffffffffc0202204:	07700593          	li	a1,119
ffffffffc0202208:	00003517          	auipc	a0,0x3
ffffffffc020220c:	13850513          	addi	a0,a0,312 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202210:	964fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202214:	00003617          	auipc	a2,0x3
ffffffffc0202218:	1c460613          	addi	a2,a2,452 # ffffffffc02053d8 <default_pmm_manager+0x150>
ffffffffc020221c:	0bd00593          	li	a1,189
ffffffffc0202220:	00003517          	auipc	a0,0x3
ffffffffc0202224:	12050513          	addi	a0,a0,288 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202228:	94cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020222c:	00003697          	auipc	a3,0x3
ffffffffc0202230:	21468693          	addi	a3,a3,532 # ffffffffc0205440 <default_pmm_manager+0x1b8>
ffffffffc0202234:	00003617          	auipc	a2,0x3
ffffffffc0202238:	ca460613          	addi	a2,a2,-860 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020223c:	19300593          	li	a1,403
ffffffffc0202240:	00003517          	auipc	a0,0x3
ffffffffc0202244:	10050513          	addi	a0,a0,256 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202248:	92cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020224c:	00003697          	auipc	a3,0x3
ffffffffc0202250:	1d468693          	addi	a3,a3,468 # ffffffffc0205420 <default_pmm_manager+0x198>
ffffffffc0202254:	00003617          	auipc	a2,0x3
ffffffffc0202258:	c8460613          	addi	a2,a2,-892 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020225c:	19200593          	li	a1,402
ffffffffc0202260:	00003517          	auipc	a0,0x3
ffffffffc0202264:	0e050513          	addi	a0,a0,224 # ffffffffc0205340 <default_pmm_manager+0xb8>
...
ffffffffc0202274:	26068693          	addi	a3,a3,608 # ffffffffc02054d0 <default_pmm_manager+0x248>
ffffffffc0202278:	00003617          	auipc	a2,0x3
ffffffffc020227c:	c6060613          	addi	a2,a2,-928 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202280:	19a00593          	li	a1,410
ffffffffc0202284:	00003517          	auipc	a0,0x3
ffffffffc0202288:	0bc50513          	addi	a0,a0,188 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc020228c:	8e8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202290:	00003697          	auipc	a3,0x3
ffffffffc0202294:	21068693          	addi	a3,a3,528 # ffffffffc02054a0 <default_pmm_manager+0x218>
ffffffffc0202298:	00003617          	auipc	a2,0x3
ffffffffc020229c:	c4060613          	addi	a2,a2,-960 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02022a0:	19800593          	li	a1,408
ffffffffc02022a4:	00003517          	auipc	a0,0x3
ffffffffc02022a8:	09c50513          	addi	a0,a0,156 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02022ac:	8c8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc02022b0:	00003697          	auipc	a3,0x3
ffffffffc02022b4:	1c868693          	addi	a3,a3,456 # ffffffffc0205478 <default_pmm_manager+0x1f0>
ffffffffc02022b8:	00003617          	auipc	a2,0x3
ffffffffc02022bc:	c2060613          	addi	a2,a2,-992 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02022c0:	19400593          	li	a1,404
ffffffffc02022c4:	00003517          	auipc	a0,0x3
ffffffffc02022c8:	07c50513          	addi	a0,a0,124 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02022cc:	8a8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02022d0:	00003697          	auipc	a3,0x3
ffffffffc02022d4:	28868693          	addi	a3,a3,648 # ffffffffc0205558 <default_pmm_manager+0x2d0>
ffffffffc02022d8:	00003617          	auipc	a2,0x3
ffffffffc02022dc:	c0060613          	addi	a2,a2,-1024 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02022e0:	1a300593          	li	a1,419
ffffffffc02022e4:	00003517          	auipc	a0,0x3
ffffffffc02022e8:	05c50513          	addi	a0,a0,92 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02022ec:	888fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02022f0:	00003697          	auipc	a3,0x3
ffffffffc02022f4:	30868693          	addi	a3,a3,776 # ffffffffc02055f8 <default_pmm_manager+0x370>
ffffffffc02022f8:	00003617          	auipc	a2,0x3
ffffffffc02022fc:	be060613          	addi	a2,a2,-1056 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202300:	1a800593          	li	a1,424
ffffffffc0202304:	00003517          	auipc	a0,0x3
ffffffffc0202308:	03c50513          	addi	a0,a0,60 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc020230c:	868fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202310:	00003697          	auipc	a3,0x3
ffffffffc0202314:	22068693          	addi	a3,a3,544 # ffffffffc0205530 <default_pmm_manager+0x2a8>
ffffffffc0202318:	00003617          	auipc	a2,0x3
ffffffffc020231c:	bc060613          	addi	a2,a2,-1088 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202320:	1a000593          	li	a1,416
ffffffffc0202324:	00003517          	auipc	a0,0x3
ffffffffc0202328:	01c50513          	addi	a0,a0,28 # ffffffffc0205340 <default_pmm_manager+0xb8>
...
ffffffffc0202336:	fe660613          	addi	a2,a2,-26 # ffffffffc0205318 <default_pmm_manager+0x90>
ffffffffc020233a:	19f00593          	li	a1,415
ffffffffc020233e:	00003517          	auipc	a0,0x3
ffffffffc0202342:	00250513          	addi	a0,a0,2 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202346:	82efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020234a:	00003697          	auipc	a3,0x3
ffffffffc020234e:	24668693          	addi	a3,a3,582 # ffffffffc0205590 <default_pmm_manager+0x308>
ffffffffc0202352:	00003617          	auipc	a2,0x3
ffffffffc0202356:	b8660613          	addi	a2,a2,-1146 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020235a:	1ad00593          	li	a1,429
ffffffffc020235e:	00003517          	auipc	a0,0x3
ffffffffc0202362:	fe250513          	addi	a0,a0,-30 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202366:	80efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020236a:	00003697          	auipc	a3,0x3
ffffffffc020236e:	2ee68693          	addi	a3,a3,750 # ffffffffc0205658 <default_pmm_manager+0x3d0>
ffffffffc0202372:	00003617          	auipc	a2,0x3
ffffffffc0202376:	b6660613          	addi	a2,a2,-1178 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020237a:	1ac00593          	li	a1,428
ffffffffc020237e:	00003517          	auipc	a0,0x3
ffffffffc0202382:	fc250513          	addi	a0,a0,-62 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202386:	feffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020238a:	00003697          	auipc	a3,0x3
ffffffffc020238e:	2b668693          	addi	a3,a3,694 # ffffffffc0205640 <default_pmm_manager+0x3b8>
ffffffffc0202392:	00003617          	auipc	a2,0x3
ffffffffc0202396:	b4660613          	addi	a2,a2,-1210 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020239a:	1ab00593          	li	a1,427
ffffffffc020239e:	00003517          	auipc	a0,0x3
ffffffffc02023a2:	fa250513          	addi	a0,a0,-94 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02023a6:	fcffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc02023aa:	00003697          	auipc	a3,0x3
ffffffffc02023ae:	26668693          	addi	a3,a3,614 # ffffffffc0205610 <default_pmm_manager+0x388>
ffffffffc02023b2:	00003617          	auipc	a2,0x3
ffffffffc02023b6:	b2660613          	addi	a2,a2,-1242 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02023ba:	1aa00593          	li	a1,426
ffffffffc02023be:	00003517          	auipc	a0,0x3
ffffffffc02023c2:	f8250513          	addi	a0,a0,-126 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02023c6:	faffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc02023ca:	00003697          	auipc	a3,0x3
ffffffffc02023ce:	3fe68693          	addi	a3,a3,1022 # ffffffffc02057c8 <default_pmm_manager+0x540>
ffffffffc02023d2:	00003617          	auipc	a2,0x3
ffffffffc02023d6:	b0660613          	addi	a2,a2,-1274 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02023da:	1d800593          	li	a1,472
ffffffffc02023de:	00003517          	auipc	a0,0x3
ffffffffc02023e2:	f6250513          	addi	a0,a0,-158 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02023e6:	f8ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02023ea:	00003697          	auipc	a3,0x3
ffffffffc02023ee:	1f668693          	addi	a3,a3,502 # ffffffffc02055e0 <default_pmm_manager+0x358>
ffffffffc02023f2:	00003617          	auipc	a2,0x3
ffffffffc02023f6:	ae660613          	addi	a2,a2,-1306 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02023fa:	1a700593          	li	a1,423
ffffffffc02023fe:	00003517          	auipc	a0,0x3
ffffffffc0202402:	f4250513          	addi	a0,a0,-190 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202406:	f6ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_W);
ffffffffc020240a:	00003697          	auipc	a3,0x3
ffffffffc020240e:	1c668693          	addi	a3,a3,454 # ffffffffc02055d0 <default_pmm_manager+0x348>
ffffffffc0202412:	00003617          	auipc	a2,0x3
ffffffffc0202416:	ac660613          	addi	a2,a2,-1338 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020241a:	1a600593          	li	a1,422
ffffffffc020241e:	00003517          	auipc	a0,0x3
ffffffffc0202422:	f2250513          	addi	a0,a0,-222 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202426:	f4ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020242a:	00003697          	auipc	a3,0x3
ffffffffc020242e:	29e68693          	addi	a3,a3,670 # ffffffffc02056c8 <default_pmm_manager+0x440>
ffffffffc0202432:	00003617          	auipc	a2,0x3
ffffffffc0202436:	aa660613          	addi	a2,a2,-1370 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020243a:	1e800593          	li	a1,488
ffffffffc020243e:	00003517          	auipc	a0,0x3
ffffffffc0202442:	f0250513          	addi	a0,a0,-254 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202446:	f2ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020244a:	00003697          	auipc	a3,0x3
ffffffffc020244e:	17668693          	addi	a3,a3,374 # ffffffffc02055c0 <default_pmm_manager+0x338>
ffffffffc0202452:	00003617          	auipc	a2,0x3
ffffffffc0202456:	a8660613          	addi	a2,a2,-1402 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020245a:	1a500593          	li	a1,421
ffffffffc020245e:	00003517          	auipc	a0,0x3
ffffffffc0202462:	ee250513          	addi	a0,a0,-286 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202466:	f0ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020246a:	00003697          	auipc	a3,0x3
ffffffffc020246e:	0ae68693          	addi	a3,a3,174 # ffffffffc0205518 <default_pmm_manager+0x290>
ffffffffc0202472:	00003617          	auipc	a2,0x3
ffffffffc0202476:	a6660613          	addi	a2,a2,-1434 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020247a:	1b200593          	li	a1,434
ffffffffc020247e:	00003517          	auipc	a0,0x3
ffffffffc0202482:	ec250513          	addi	a0,a0,-318 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202486:	eeffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020248a:	00003697          	auipc	a3,0x3
ffffffffc020248e:	1e668693          	addi	a3,a3,486 # ffffffffc0205670 <default_pmm_manager+0x3e8>
ffffffffc0202492:	00003617          	auipc	a2,0x3
ffffffffc0202496:	a4660613          	addi	a2,a2,-1466 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020249a:	1af00593          	li	a1,431
ffffffffc020249e:	00003517          	auipc	a0,0x3
ffffffffc02024a2:	ea250513          	addi	a0,a0,-350 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02024a6:	ecffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02024aa:	00003697          	auipc	a3,0x3
ffffffffc02024ae:	05668693          	addi	a3,a3,86 # ffffffffc0205500 <default_pmm_manager+0x278>
ffffffffc02024b2:	00003617          	auipc	a2,0x3
ffffffffc02024b6:	a2660613          	addi	a2,a2,-1498 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02024ba:	1ae00593          	li	a1,430
ffffffffc02024be:	00003517          	auipc	a0,0x3
ffffffffc02024c2:	e8250513          	addi	a0,a0,-382 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02024c6:	eaffd0ef          	jal	ra,ffffffffc0200374 <__panic>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc02024ca:	00003617          	auipc	a2,0x3
ffffffffc02024ce:	e4e60613          	addi	a2,a2,-434 # ffffffffc0205318 <default_pmm_manager+0x90>
ffffffffc02024d2:	06a00593          	li	a1,106
ffffffffc02024d6:	00003517          	auipc	a0,0x3
ffffffffc02024da:	e0a50513          	addi	a0,a0,-502 # ffffffffc02052e0 <default_pmm_manager+0x58>
ffffffffc02024de:	e97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024e2:	00003697          	auipc	a3,0x3
ffffffffc02024e6:	1be68693          	addi	a3,a3,446 # ffffffffc02056a0 <default_pmm_manager+0x418>
ffffffffc02024ea:	00003617          	auipc	a2,0x3
ffffffffc02024ee:	9ee60613          	addi	a2,a2,-1554 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02024f2:	1b900593          	li	a1,441
ffffffffc02024f6:	00003517          	auipc	a0,0x3
ffffffffc02024fa:	e4a50513          	addi	a0,a0,-438 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02024fe:	e77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202502:	00003697          	auipc	a3,0x3
ffffffffc0202506:	15668693          	addi	a3,a3,342 # ffffffffc0205658 <default_pmm_manager+0x3d0>
ffffffffc020250a:	00003617          	auipc	a2,0x3
ffffffffc020250e:	9ce60613          	addi	a2,a2,-1586 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202512:	1b700593          	li	a1,439
ffffffffc0202516:	00003517          	auipc	a0,0x3
ffffffffc020251a:	e2a50513          	addi	a0,a0,-470 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc020251e:	e57fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202522:	00003697          	auipc	a3,0x3
ffffffffc0202526:	16668693          	addi	a3,a3,358 # ffffffffc0205688 <default_pmm_manager+0x400>
ffffffffc020252a:	00003617          	auipc	a2,0x3
ffffffffc020252e:	9ae60613          	addi	a2,a2,-1618 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202532:	1b600593          	li	a1,438
ffffffffc0202536:	00003517          	auipc	a0,0x3
ffffffffc020253a:	e0a50513          	addi	a0,a0,-502 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc020253e:	e37fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202542:	00003697          	auipc	a3,0x3
ffffffffc0202546:	11668693          	addi	a3,a3,278 # ffffffffc0205658 <default_pmm_manager+0x3d0>
ffffffffc020254a:	00003617          	auipc	a2,0x3
ffffffffc020254e:	98e60613          	addi	a2,a2,-1650 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202552:	1b300593          	li	a1,435
ffffffffc0202556:	00003517          	auipc	a0,0x3
ffffffffc020255a:	dea50513          	addi	a0,a0,-534 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc020255e:	e17fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202562:	00003697          	auipc	a3,0x3
ffffffffc0202566:	24e68693          	addi	a3,a3,590 # ffffffffc02057b0 <default_pmm_manager+0x528>
ffffffffc020256a:	00003617          	auipc	a2,0x3
ffffffffc020256e:	96e60613          	addi	a2,a2,-1682 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202572:	1d700593          	li	a1,471
ffffffffc0202576:	00003517          	auipc	a0,0x3
ffffffffc020257a:	dca50513          	addi	a0,a0,-566 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc020257e:	df7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202582:	00003697          	auipc	a3,0x3
ffffffffc0202586:	1f668693          	addi	a3,a3,502 # ffffffffc0205778 <default_pmm_manager+0x4f0>
ffffffffc020258a:	00003617          	auipc	a2,0x3
ffffffffc020258e:	94e60613          	addi	a2,a2,-1714 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202592:	1d600593          	li	a1,470
ffffffffc0202596:	00003517          	auipc	a0,0x3
ffffffffc020259a:	daa50513          	addi	a0,a0,-598 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc020259e:	dd7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02025a2:	00003697          	auipc	a3,0x3
ffffffffc02025a6:	1be68693          	addi	a3,a3,446 # ffffffffc0205760 <default_pmm_manager+0x4d8>
ffffffffc02025aa:	00003617          	auipc	a2,0x3
ffffffffc02025ae:	92e60613          	addi	a2,a2,-1746 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02025b2:	1d200593          	li	a1,466
ffffffffc02025b6:	00003517          	auipc	a0,0x3
ffffffffc02025ba:	d8a50513          	addi	a0,a0,-630 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02025be:	db7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02025c2:	00003697          	auipc	a3,0x3
ffffffffc02025c6:	10668693          	addi	a3,a3,262 # ffffffffc02056c8 <default_pmm_manager+0x440>
ffffffffc02025ca:	00003617          	auipc	a2,0x3
ffffffffc02025ce:	90e60613          	addi	a2,a2,-1778 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02025d2:	1c000593          	li	a1,448
ffffffffc02025d6:	00003517          	auipc	a0,0x3
ffffffffc02025da:	d6a50513          	addi	a0,a0,-662 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02025de:	d97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025e2:	00003697          	auipc	a3,0x3
ffffffffc02025e6:	f1e68693          	addi	a3,a3,-226 # ffffffffc0205500 <default_pmm_manager+0x278>
ffffffffc02025ea:	00003617          	auipc	a2,0x3
ffffffffc02025ee:	8ee60613          	addi	a2,a2,-1810 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02025f2:	19b00593          	li	a1,411
ffffffffc02025f6:	00003517          	auipc	a0,0x3
ffffffffc02025fa:	d4a50513          	addi	a0,a0,-694 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02025fe:	d77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc0202602:	00003617          	auipc	a2,0x3
ffffffffc0202606:	d1660613          	addi	a2,a2,-746 # ffffffffc0205318 <default_pmm_manager+0x90>
ffffffffc020260a:	19e00593          	li	a1,414
ffffffffc020260e:	00003517          	auipc	a0,0x3
ffffffffc0202612:	d3250513          	addi	a0,a0,-718 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202616:	d5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020261a:	00003697          	auipc	a3,0x3
ffffffffc020261e:	efe68693          	addi	a3,a3,-258 # ffffffffc0205518 <default_pmm_manager+0x290>
ffffffffc0202622:	00003617          	auipc	a2,0x3
ffffffffc0202626:	8b660613          	addi	a2,a2,-1866 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020262a:	19c00593          	li	a1,412
ffffffffc020262e:	00003517          	auipc	a0,0x3
ffffffffc0202632:	d1250513          	addi	a0,a0,-750 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202636:	d3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020263a:	00003697          	auipc	a3,0x3
ffffffffc020263e:	f5668693          	addi	a3,a3,-170 # ffffffffc0205590 <default_pmm_manager+0x308>
ffffffffc0202642:	00003617          	auipc	a2,0x3
ffffffffc0202646:	89660613          	addi	a2,a2,-1898 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020264a:	1a400593          	li	a1,420
ffffffffc020264e:	00003517          	auipc	a0,0x3
ffffffffc0202652:	cf250513          	addi	a0,a0,-782 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202656:	d1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020265a:	00003697          	auipc	a3,0x3
ffffffffc020265e:	21668693          	addi	a3,a3,534 # ffffffffc0205870 <default_pmm_manager+0x5e8>
ffffffffc0202662:	00003617          	auipc	a2,0x3
ffffffffc0202666:	87660613          	addi	a2,a2,-1930 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020266a:	1e000593          	li	a1,480
ffffffffc020266e:	00003517          	auipc	a0,0x3
ffffffffc0202672:	cd250513          	addi	a0,a0,-814 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202676:	cfffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020267a:	00003697          	auipc	a3,0x3
ffffffffc020267e:	1be68693          	addi	a3,a3,446 # ffffffffc0205838 <default_pmm_manager+0x5b0>
ffffffffc0202682:	00003617          	auipc	a2,0x3
ffffffffc0202686:	85660613          	addi	a2,a2,-1962 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020268a:	1dd00593          	li	a1,477
ffffffffc020268e:	00003517          	auipc	a0,0x3
ffffffffc0202692:	cb250513          	addi	a0,a0,-846 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc0202696:	cdffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020269a:	00003697          	auipc	a3,0x3
ffffffffc020269e:	16e68693          	addi	a3,a3,366 # ffffffffc0205808 <default_pmm_manager+0x580>
ffffffffc02026a2:	00003617          	auipc	a2,0x3
ffffffffc02026a6:	83660613          	addi	a2,a2,-1994 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02026aa:	1d900593          	li	a1,473
ffffffffc02026ae:	00003517          	auipc	a0,0x3
ffffffffc02026b2:	c9250513          	addi	a0,a0,-878 # ffffffffc0205340 <default_pmm_manager+0xb8>
...
ffffffffc0202724:	19868693          	addi	a3,a3,408 # ffffffffc02058b8 <default_pmm_manager+0x630>
ffffffffc0202728:	00002617          	auipc	a2,0x2
ffffffffc020272c:	7b060613          	addi	a2,a2,1968 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202730:	17a00593          	li	a1,378
ffffffffc0202734:	00003517          	auipc	a0,0x3
ffffffffc0202738:	c0c50513          	addi	a0,a0,-1012 # ffffffffc0205340 <default_pmm_manager+0xb8>
...
ffffffffc02027a4:	bc86b683          	ld	a3,-1080(a3) # ffffffffc0206368 <error_string+0x38>
...
ffffffffc02027dc:	0f868693          	addi	a3,a3,248 # ffffffffc02058d0 <default_pmm_manager+0x648>
ffffffffc02027e0:	00002617          	auipc	a2,0x2
ffffffffc02027e4:	6f860613          	addi	a2,a2,1784 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02027e8:	1f000593          	li	a1,496
ffffffffc02027ec:	00003517          	auipc	a0,0x3
ffffffffc02027f0:	b5450513          	addi	a0,a0,-1196 # ffffffffc0205340 <default_pmm_manager+0xb8>
...
ffffffffc02027fe:	b1e60613          	addi	a2,a2,-1250 # ffffffffc0205318 <default_pmm_manager+0x90>
ffffffffc0202802:	06a00593          	li	a1,106
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	ada50513          	addi	a0,a0,-1318 # ffffffffc02052e0 <default_pmm_manager+0x58>
ffffffffc020280e:	b67fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	0de68693          	addi	a3,a3,222 # ffffffffc02058f0 <default_pmm_manager+0x668>
ffffffffc020281a:	00002617          	auipc	a2,0x2
ffffffffc020281e:	6be60613          	addi	a2,a2,1726 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202822:	1f300593          	li	a1,499
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	b1a50513          	addi	a0,a0,-1254 # ffffffffc0205340 <default_pmm_manager+0xb8>
...
ffffffffc02028c6:	b1660613          	addi	a2,a2,-1258 # ffffffffc02053d8 <default_pmm_manager+0x150>
ffffffffc02028ca:	06c00593          	li	a1,108
ffffffffc02028ce:	00003517          	auipc	a0,0x3
ffffffffc02028d2:	a1250513          	addi	a0,a0,-1518 # ffffffffc02052e0 <default_pmm_manager+0x58>
ffffffffc02028d6:	a9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02028da:	00003697          	auipc	a3,0x3
ffffffffc02028de:	02668693          	addi	a3,a3,38 # ffffffffc0205900 <default_pmm_manager+0x678>
ffffffffc02028e2:	00002617          	auipc	a2,0x2
ffffffffc02028e6:	5f660613          	addi	a2,a2,1526 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02028ea:	1fa00593          	li	a1,506
ffffffffc02028ee:	00003517          	auipc	a0,0x3
ffffffffc02028f2:	a5250513          	addi	a0,a0,-1454 # ffffffffc0205340 <default_pmm_manager+0xb8>
ffffffffc02028f6:	a7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0 && n < 1024 * 0124);
ffffffffc02028fa:	00003697          	auipc	a3,0x3
ffffffffc02028fe:	fd668693          	addi	a3,a3,-42 # ffffffffc02058d0 <default_pmm_manager+0x648>
ffffffffc0202902:	00002617          	auipc	a2,0x2
ffffffffc0202906:	5d660613          	addi	a2,a2,1494 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020290a:	1f900593          	li	a1,505
ffffffffc020290e:	00003517          	auipc	a0,0x3
ffffffffc0202912:	a3250513          	addi	a0,a0,-1486 # ffffffffc0205340 <default_pmm_manager+0xb8>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	55e010ef          	jal	ra,ffffffffc0203e94 <swapfs_init>
...
ffffffffc0202994:	fb050513          	addi	a0,a0,-80 # ffffffffc0205940 <default_pmm_manager+0x6b8>
    return listelm->next;
...
ffffffffc02029e4:	f7850513          	addi	a0,a0,-136 # ffffffffc0205958 <default_pmm_manager+0x6d0>
ffffffffc02029e8:	ed2fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02029ec:	3f9000ef          	jal	ra,ffffffffc02035e4 <mm_create>
...
ffffffffc0202a20:	40d000ef          	jal	ra,ffffffffc020362c <vma_create>
...
ffffffffc0202a2c:	46f000ef          	jal	ra,ffffffffc020369a <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	f9850513          	addi	a0,a0,-104 # ffffffffc02059c8 <default_pmm_manager+0x740>
...
ffffffffc0202a50:	fcc50513          	addi	a0,a0,-52 # ffffffffc0205a18 <default_pmm_manager+0x790>
...
ffffffffc0202ac4:	fe050513          	addi	a0,a0,-32 # ffffffffc0205aa0 <default_pmm_manager+0x818>
...
ffffffffc0202ba0:	7d4c0c13          	addi	s8,s8,2004 # ffffffffc0206370 <nbase>
...
ffffffffc0202c10:	f3c50513          	addi	a0,a0,-196 # ffffffffc0205b48 <default_pmm_manager+0x8c0>
...
ffffffffc0202c36:	335000ef          	jal	ra,ffffffffc020376a <mm_destroy>
...
ffffffffc0202c62:	f1a50513          	addi	a0,a0,-230 # ffffffffc0205b78 <default_pmm_manager+0x8f0>
ffffffffc0202c66:	c54fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6a:	00003517          	auipc	a0,0x3
ffffffffc0202c6e:	f2e50513          	addi	a0,a0,-210 # ffffffffc0205b98 <default_pmm_manager+0x910>
...
ffffffffc0202c80:	24c68693          	addi	a3,a3,588 # ffffffffc0204ec8 <commands+0x728>
ffffffffc0202c84:	00002617          	auipc	a2,0x2
ffffffffc0202c88:	25460613          	addi	a2,a2,596 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202c8c:	0be00593          	li	a1,190
ffffffffc0202c90:	00003517          	auipc	a0,0x3
ffffffffc0202c94:	ca050513          	addi	a0,a0,-864 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202c98:	edcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9c:	00003697          	auipc	a3,0x3
ffffffffc0202ca0:	e8468693          	addi	a3,a3,-380 # ffffffffc0205b20 <default_pmm_manager+0x898>
ffffffffc0202ca4:	00002617          	auipc	a2,0x2
ffffffffc0202ca8:	23460613          	addi	a2,a2,564 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202cac:	0fe00593          	li	a1,254
ffffffffc0202cb0:	00003517          	auipc	a0,0x3
ffffffffc0202cb4:	c8050513          	addi	a0,a0,-896 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202cb8:	ebcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbc:	00002617          	auipc	a2,0x2
ffffffffc0202cc0:	63460613          	addi	a2,a2,1588 # ffffffffc02052f0 <default_pmm_manager+0x68>
ffffffffc0202cc4:	07000593          	li	a1,112
ffffffffc0202cc8:	00002517          	auipc	a0,0x2
ffffffffc0202ccc:	61850513          	addi	a0,a0,1560 # ffffffffc02052e0 <default_pmm_manager+0x58>
ffffffffc0202cd0:	ea4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	5ec60613          	addi	a2,a2,1516 # ffffffffc02052c0 <default_pmm_manager+0x38>
ffffffffc0202cdc:	06500593          	li	a1,101
ffffffffc0202ce0:	00002517          	auipc	a0,0x2
ffffffffc0202ce4:	60050513          	addi	a0,a0,1536 # ffffffffc02052e0 <default_pmm_manager+0x58>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	d6c68693          	addi	a3,a3,-660 # ffffffffc0205a58 <default_pmm_manager+0x7d0>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	1e460613          	addi	a2,a2,484 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202cfc:	0df00593          	li	a1,223
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	c3050513          	addi	a0,a0,-976 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	d3468693          	addi	a3,a3,-716 # ffffffffc0205a40 <default_pmm_manager+0x7b8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	1c460613          	addi	a2,a2,452 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202d1c:	0de00593          	li	a1,222
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	c1050513          	addi	a0,a0,-1008 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2c:	00003617          	auipc	a2,0x3
ffffffffc0202d30:	be460613          	addi	a2,a2,-1052 # ffffffffc0205910 <default_pmm_manager+0x688>
ffffffffc0202d34:	02800593          	li	a1,40
ffffffffc0202d38:	00003517          	auipc	a0,0x3
ffffffffc0202d3c:	bf850513          	addi	a0,a0,-1032 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202d40:	e34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d44:	00003697          	auipc	a3,0x3
ffffffffc0202d48:	dc468693          	addi	a3,a3,-572 # ffffffffc0205b08 <default_pmm_manager+0x880>
ffffffffc0202d4c:	00002617          	auipc	a2,0x2
ffffffffc0202d50:	18c60613          	addi	a2,a2,396 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202d54:	0fd00593          	li	a1,253
ffffffffc0202d58:	00003517          	auipc	a0,0x3
ffffffffc0202d5c:	bd850513          	addi	a0,a0,-1064 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202d60:	e14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d64:	00003697          	auipc	a3,0x3
ffffffffc0202d68:	d9468693          	addi	a3,a3,-620 # ffffffffc0205af8 <default_pmm_manager+0x870>
ffffffffc0202d6c:	00002617          	auipc	a2,0x2
ffffffffc0202d70:	16c60613          	addi	a2,a2,364 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202d74:	0a100593          	li	a1,161
ffffffffc0202d78:	00003517          	auipc	a0,0x3
ffffffffc0202d7c:	bb850513          	addi	a0,a0,-1096 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202d80:	df4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d84:	00003697          	auipc	a3,0x3
ffffffffc0202d88:	d7468693          	addi	a3,a3,-652 # ffffffffc0205af8 <default_pmm_manager+0x870>
ffffffffc0202d8c:	00002617          	auipc	a2,0x2
ffffffffc0202d90:	14c60613          	addi	a2,a2,332 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202d94:	0a300593          	li	a1,163
ffffffffc0202d98:	00003517          	auipc	a0,0x3
ffffffffc0202d9c:	b9850513          	addi	a0,a0,-1128 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202da0:	dd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202da4:	00002697          	auipc	a3,0x2
ffffffffc0202da8:	30c68693          	addi	a3,a3,780 # ffffffffc02050b0 <commands+0x910>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	12c60613          	addi	a2,a2,300 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202db4:	0f500593          	li	a1,245
ffffffffc0202db8:	00003517          	auipc	a0,0x3
ffffffffc0202dbc:	b7850513          	addi	a0,a0,-1160 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202dc0:	db4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dc4:	00003697          	auipc	a3,0x3
ffffffffc0202dc8:	dac68693          	addi	a3,a3,-596 # ffffffffc0205b70 <default_pmm_manager+0x8e8>
ffffffffc0202dcc:	00002617          	auipc	a2,0x2
ffffffffc0202dd0:	10c60613          	addi	a2,a2,268 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202dd4:	10400593          	li	a1,260
ffffffffc0202dd8:	00003517          	auipc	a0,0x3
ffffffffc0202ddc:	b5850513          	addi	a0,a0,-1192 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202de0:	d94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202de4:	00003697          	auipc	a3,0x3
ffffffffc0202de8:	bc468693          	addi	a3,a3,-1084 # ffffffffc02059a8 <default_pmm_manager+0x720>
ffffffffc0202dec:	00002617          	auipc	a2,0x2
ffffffffc0202df0:	0ec60613          	addi	a2,a2,236 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202df4:	0ce00593          	li	a1,206
ffffffffc0202df8:	00003517          	auipc	a0,0x3
ffffffffc0202dfc:	b3850513          	addi	a0,a0,-1224 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202e00:	d74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e04:	00003697          	auipc	a3,0x3
ffffffffc0202e08:	bb468693          	addi	a3,a3,-1100 # ffffffffc02059b8 <default_pmm_manager+0x730>
ffffffffc0202e0c:	00002617          	auipc	a2,0x2
ffffffffc0202e10:	0cc60613          	addi	a2,a2,204 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202e14:	0d100593          	li	a1,209
ffffffffc0202e18:	00003517          	auipc	a0,0x3
ffffffffc0202e1c:	b1850513          	addi	a0,a0,-1256 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202e20:	d54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202e24:	00003697          	auipc	a3,0x3
ffffffffc0202e28:	bdc68693          	addi	a3,a3,-1060 # ffffffffc0205a00 <default_pmm_manager+0x778>
ffffffffc0202e2c:	00002617          	auipc	a2,0x2
ffffffffc0202e30:	0ac60613          	addi	a2,a2,172 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202e34:	0d900593          	li	a1,217
ffffffffc0202e38:	00003517          	auipc	a0,0x3
ffffffffc0202e3c:	af850513          	addi	a0,a0,-1288 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202e40:	d34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e44:	00002697          	auipc	a3,0x2
ffffffffc0202e48:	0c468693          	addi	a3,a3,196 # ffffffffc0204f08 <commands+0x768>
ffffffffc0202e4c:	00002617          	auipc	a2,0x2
ffffffffc0202e50:	08c60613          	addi	a2,a2,140 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202e54:	0c100593          	li	a1,193
ffffffffc0202e58:	00003517          	auipc	a0,0x3
ffffffffc0202e5c:	ad850513          	addi	a0,a0,-1320 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202e60:	d14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e64:	00003697          	auipc	a3,0x3
ffffffffc0202e68:	c7468693          	addi	a3,a3,-908 # ffffffffc0205ad8 <default_pmm_manager+0x850>
ffffffffc0202e6c:	00002617          	auipc	a2,0x2
ffffffffc0202e70:	06c60613          	addi	a2,a2,108 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202e74:	09900593          	li	a1,153
ffffffffc0202e78:	00003517          	auipc	a0,0x3
ffffffffc0202e7c:	ab850513          	addi	a0,a0,-1352 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202e80:	cf4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e84:	00003697          	auipc	a3,0x3
ffffffffc0202e88:	c5468693          	addi	a3,a3,-940 # ffffffffc0205ad8 <default_pmm_manager+0x850>
ffffffffc0202e8c:	00002617          	auipc	a2,0x2
ffffffffc0202e90:	04c60613          	addi	a2,a2,76 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202e94:	09b00593          	li	a1,155
ffffffffc0202e98:	00003517          	auipc	a0,0x3
ffffffffc0202e9c:	a9850513          	addi	a0,a0,-1384 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202ea0:	cd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ea4:	00003697          	auipc	a3,0x3
ffffffffc0202ea8:	c4468693          	addi	a3,a3,-956 # ffffffffc0205ae8 <default_pmm_manager+0x860>
ffffffffc0202eac:	00002617          	auipc	a2,0x2
ffffffffc0202eb0:	02c60613          	addi	a2,a2,44 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202eb4:	09d00593          	li	a1,157
ffffffffc0202eb8:	00003517          	auipc	a0,0x3
ffffffffc0202ebc:	a7850513          	addi	a0,a0,-1416 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202ec0:	cb4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ec4:	00003697          	auipc	a3,0x3
ffffffffc0202ec8:	c2468693          	addi	a3,a3,-988 # ffffffffc0205ae8 <default_pmm_manager+0x860>
ffffffffc0202ecc:	00002617          	auipc	a2,0x2
ffffffffc0202ed0:	00c60613          	addi	a2,a2,12 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202ed4:	09f00593          	li	a1,159
ffffffffc0202ed8:	00003517          	auipc	a0,0x3
ffffffffc0202edc:	a5850513          	addi	a0,a0,-1448 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202ee0:	c94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202ee4:	00003697          	auipc	a3,0x3
ffffffffc0202ee8:	be468693          	addi	a3,a3,-1052 # ffffffffc0205ac8 <default_pmm_manager+0x840>
ffffffffc0202eec:	00002617          	auipc	a2,0x2
ffffffffc0202ef0:	fec60613          	addi	a2,a2,-20 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202ef4:	09500593          	li	a1,149
ffffffffc0202ef8:	00003517          	auipc	a0,0x3
ffffffffc0202efc:	a3850513          	addi	a0,a0,-1480 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202f00:	c74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202f04:	00003697          	auipc	a3,0x3
ffffffffc0202f08:	bc468693          	addi	a3,a3,-1084 # ffffffffc0205ac8 <default_pmm_manager+0x840>
ffffffffc0202f0c:	00002617          	auipc	a2,0x2
ffffffffc0202f10:	fcc60613          	addi	a2,a2,-52 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202f14:	09700593          	li	a1,151
ffffffffc0202f18:	00003517          	auipc	a0,0x3
ffffffffc0202f1c:	a1850513          	addi	a0,a0,-1512 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202f20:	c54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202f24:	00003697          	auipc	a3,0x3
ffffffffc0202f28:	a5c68693          	addi	a3,a3,-1444 # ffffffffc0205980 <default_pmm_manager+0x6f8>
ffffffffc0202f2c:	00002617          	auipc	a2,0x2
ffffffffc0202f30:	fac60613          	addi	a2,a2,-84 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202f34:	0c600593          	li	a1,198
ffffffffc0202f38:	00003517          	auipc	a0,0x3
ffffffffc0202f3c:	9f850513          	addi	a0,a0,-1544 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202f40:	c34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202f44:	00003697          	auipc	a3,0x3
ffffffffc0202f48:	a4c68693          	addi	a3,a3,-1460 # ffffffffc0205990 <default_pmm_manager+0x708>
ffffffffc0202f4c:	00002617          	auipc	a2,0x2
ffffffffc0202f50:	f8c60613          	addi	a2,a2,-116 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202f54:	0c900593          	li	a1,201
ffffffffc0202f58:	00003517          	auipc	a0,0x3
ffffffffc0202f5c:	9d850513          	addi	a0,a0,-1576 # ffffffffc0205930 <default_pmm_manager+0x6a8>
ffffffffc0202f60:	c14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202f64:	00003697          	auipc	a3,0x3
ffffffffc0202f68:	b1468693          	addi	a3,a3,-1260 # ffffffffc0205a78 <default_pmm_manager+0x7f0>
ffffffffc0202f6c:	00002617          	auipc	a2,0x2
ffffffffc0202f70:	f6c60613          	addi	a2,a2,-148 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0202f74:	0ec00593          	li	a1,236
ffffffffc0202f78:	00003517          	auipc	a0,0x3
ffffffffc0202f7c:	9b850513          	addi	a0,a0,-1608 # ffffffffc0205930 <default_pmm_manager+0x6a8>
...
ffffffffc0202fc8:	c54b0b13          	addi	s6,s6,-940 # ffffffffc0205c18 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fcc:	00003b97          	auipc	s7,0x3
ffffffffc0202fd0:	c34b8b93          	addi	s7,s7,-972 # ffffffffc0205c00 <default_pmm_manager+0x978>
...
ffffffffc0203040:	727000ef          	jal	ra,ffffffffc0203f66 <swapfs_write>
...
ffffffffc0203082:	b3a50513          	addi	a0,a0,-1222 # ffffffffc0205bb8 <default_pmm_manager+0x930>
...
ffffffffc0203094:	b5868693          	addi	a3,a3,-1192 # ffffffffc0205be8 <default_pmm_manager+0x960>
ffffffffc0203098:	00002617          	auipc	a2,0x2
ffffffffc020309c:	e4060613          	addi	a2,a2,-448 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02030a0:	06a00593          	li	a1,106
ffffffffc02030a4:	00003517          	auipc	a0,0x3
ffffffffc02030a8:	88c50513          	addi	a0,a0,-1908 # ffffffffc0205930 <default_pmm_manager+0x6a8>
...
ffffffffc02030de:	5ef000ef          	jal	ra,ffffffffc0203ecc <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e2:	00093583          	ld	a1,0(s2)
ffffffffc02030e6:	8626                	mv	a2,s1
ffffffffc02030e8:	00003517          	auipc	a0,0x3
ffffffffc02030ec:	b8050513          	addi	a0,a0,-1152 # ffffffffc0205c68 <default_pmm_manager+0x9e0>
...
ffffffffc020310e:	b4e68693          	addi	a3,a3,-1202 # ffffffffc0205c58 <default_pmm_manager+0x9d0>
ffffffffc0203112:	00002617          	auipc	a2,0x2
ffffffffc0203116:	dc660613          	addi	a2,a2,-570 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020311a:	08000593          	li	a1,128
ffffffffc020311e:	00003517          	auipc	a0,0x3
ffffffffc0203122:	81250513          	addi	a0,a0,-2030 # ffffffffc0205930 <default_pmm_manager+0x6a8>
...
ffffffffc0203210:	8ec68693          	addi	a3,a3,-1812 # ffffffffc0205af8 <default_pmm_manager+0x870>
ffffffffc0203214:	00002617          	auipc	a2,0x2
ffffffffc0203218:	cc460613          	addi	a2,a2,-828 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020321c:	08c00593          	li	a1,140
ffffffffc0203220:	00003517          	auipc	a0,0x3
ffffffffc0203224:	a8850513          	addi	a0,a0,-1400 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc0203228:	94cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc020322c:	00003697          	auipc	a3,0x3
ffffffffc0203230:	acc68693          	addi	a3,a3,-1332 # ffffffffc0205cf8 <default_pmm_manager+0xa70>
ffffffffc0203234:	00002617          	auipc	a2,0x2
ffffffffc0203238:	ca460613          	addi	a2,a2,-860 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020323c:	0a300593          	li	a1,163
ffffffffc0203240:	00003517          	auipc	a0,0x3
ffffffffc0203244:	a6850513          	addi	a0,a0,-1432 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc0203248:	92cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020324c:	00003697          	auipc	a3,0x3
ffffffffc0203250:	a8468693          	addi	a3,a3,-1404 # ffffffffc0205cd0 <default_pmm_manager+0xa48>
ffffffffc0203254:	00002617          	auipc	a2,0x2
ffffffffc0203258:	c8460613          	addi	a2,a2,-892 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020325c:	0a100593          	li	a1,161
ffffffffc0203260:	00003517          	auipc	a0,0x3
ffffffffc0203264:	a4850513          	addi	a0,a0,-1464 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc0203268:	90cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020326c:	00003697          	auipc	a3,0x3
ffffffffc0203270:	a5468693          	addi	a3,a3,-1452 # ffffffffc0205cc0 <default_pmm_manager+0xa38>
ffffffffc0203274:	00002617          	auipc	a2,0x2
ffffffffc0203278:	c6460613          	addi	a2,a2,-924 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020327c:	0a000593          	li	a1,160
ffffffffc0203280:	00003517          	auipc	a0,0x3
ffffffffc0203284:	a2850513          	addi	a0,a0,-1496 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc0203288:	8ecfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020328c:	00003697          	auipc	a3,0x3
ffffffffc0203290:	a3468693          	addi	a3,a3,-1484 # ffffffffc0205cc0 <default_pmm_manager+0xa38>
ffffffffc0203294:	00002617          	auipc	a2,0x2
ffffffffc0203298:	c4460613          	addi	a2,a2,-956 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020329c:	09e00593          	li	a1,158
ffffffffc02032a0:	00003517          	auipc	a0,0x3
ffffffffc02032a4:	a0850513          	addi	a0,a0,-1528 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc02032a8:	8ccfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032ac:	00003697          	auipc	a3,0x3
ffffffffc02032b0:	a1468693          	addi	a3,a3,-1516 # ffffffffc0205cc0 <default_pmm_manager+0xa38>
ffffffffc02032b4:	00002617          	auipc	a2,0x2
ffffffffc02032b8:	c2460613          	addi	a2,a2,-988 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02032bc:	09c00593          	li	a1,156
ffffffffc02032c0:	00003517          	auipc	a0,0x3
ffffffffc02032c4:	9e850513          	addi	a0,a0,-1560 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc02032c8:	8acfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032cc:	00003697          	auipc	a3,0x3
ffffffffc02032d0:	9f468693          	addi	a3,a3,-1548 # ffffffffc0205cc0 <default_pmm_manager+0xa38>
ffffffffc02032d4:	00002617          	auipc	a2,0x2
ffffffffc02032d8:	c0460613          	addi	a2,a2,-1020 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02032dc:	09a00593          	li	a1,154
ffffffffc02032e0:	00003517          	auipc	a0,0x3
ffffffffc02032e4:	9c850513          	addi	a0,a0,-1592 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc02032e8:	88cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032ec:	00003697          	auipc	a3,0x3
ffffffffc02032f0:	9d468693          	addi	a3,a3,-1580 # ffffffffc0205cc0 <default_pmm_manager+0xa38>
ffffffffc02032f4:	00002617          	auipc	a2,0x2
ffffffffc02032f8:	be460613          	addi	a2,a2,-1052 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02032fc:	09800593          	li	a1,152
ffffffffc0203300:	00003517          	auipc	a0,0x3
ffffffffc0203304:	9a850513          	addi	a0,a0,-1624 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc0203308:	86cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020330c:	00003697          	auipc	a3,0x3
ffffffffc0203310:	9b468693          	addi	a3,a3,-1612 # ffffffffc0205cc0 <default_pmm_manager+0xa38>
ffffffffc0203314:	00002617          	auipc	a2,0x2
ffffffffc0203318:	bc460613          	addi	a2,a2,-1084 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020331c:	09600593          	li	a1,150
ffffffffc0203320:	00003517          	auipc	a0,0x3
ffffffffc0203324:	98850513          	addi	a0,a0,-1656 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc0203328:	84cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020332c:	00003697          	auipc	a3,0x3
ffffffffc0203330:	99468693          	addi	a3,a3,-1644 # ffffffffc0205cc0 <default_pmm_manager+0xa38>
ffffffffc0203334:	00002617          	auipc	a2,0x2
ffffffffc0203338:	ba460613          	addi	a2,a2,-1116 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020333c:	09400593          	li	a1,148
ffffffffc0203340:	00003517          	auipc	a0,0x3
ffffffffc0203344:	96850513          	addi	a0,a0,-1688 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc0203348:	82cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020334c:	00002697          	auipc	a3,0x2
ffffffffc0203350:	7ac68693          	addi	a3,a3,1964 # ffffffffc0205af8 <default_pmm_manager+0x870>
ffffffffc0203354:	00002617          	auipc	a2,0x2
ffffffffc0203358:	b8460613          	addi	a2,a2,-1148 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020335c:	09200593          	li	a1,146
ffffffffc0203360:	00003517          	auipc	a0,0x3
ffffffffc0203364:	94850513          	addi	a0,a0,-1720 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc0203368:	80cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020336c:	00002697          	auipc	a3,0x2
ffffffffc0203370:	78c68693          	addi	a3,a3,1932 # ffffffffc0205af8 <default_pmm_manager+0x870>
ffffffffc0203374:	00002617          	auipc	a2,0x2
ffffffffc0203378:	b6460613          	addi	a2,a2,-1180 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020337c:	09000593          	li	a1,144
ffffffffc0203380:	00003517          	auipc	a0,0x3
ffffffffc0203384:	92850513          	addi	a0,a0,-1752 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc0203388:	fedfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020338c:	00002697          	auipc	a3,0x2
ffffffffc0203390:	76c68693          	addi	a3,a3,1900 # ffffffffc0205af8 <default_pmm_manager+0x870>
ffffffffc0203394:	00002617          	auipc	a2,0x2
ffffffffc0203398:	b4460613          	addi	a2,a2,-1212 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020339c:	08e00593          	li	a1,142
ffffffffc02033a0:	00003517          	auipc	a0,0x3
ffffffffc02033a4:	90850513          	addi	a0,a0,-1784 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
...
ffffffffc02033b4:	7514                	ld	a3,40(a0)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02033b6:	cf89                	beqz	a5,ffffffffc02033d0 <_clock_map_swappable+0x24>
    list_add(head->prev,entry);
ffffffffc02033b8:	629c                	ld	a5,0(a3)
ffffffffc02033ba:	03060713          	addi	a4,a2,48
}
ffffffffc02033be:	4501                	li	a0,0
    __list_add(elm, listelm, listelm->next);
ffffffffc02033c0:	6794                	ld	a3,8(a5)
    prev->next = next->prev = elm;
ffffffffc02033c2:	e298                	sd	a4,0(a3)
ffffffffc02033c4:	e798                	sd	a4,8(a5)
    elm->prev = prev;
ffffffffc02033c6:	fa1c                	sd	a5,48(a2)
    page->visited = 1;
ffffffffc02033c8:	4785                	li	a5,1
    elm->next = next;
ffffffffc02033ca:	fe14                	sd	a3,56(a2)
ffffffffc02033cc:	ea1c                	sd	a5,16(a2)
}
ffffffffc02033ce:	8082                	ret
{
ffffffffc02033d0:	1141                	addi	sp,sp,-16
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02033d2:	00003697          	auipc	a3,0x3
ffffffffc02033d6:	93668693          	addi	a3,a3,-1738 # ffffffffc0205d08 <default_pmm_manager+0xa80>
ffffffffc02033da:	00002617          	auipc	a2,0x2
ffffffffc02033de:	afe60613          	addi	a2,a2,-1282 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02033e2:	03800593          	li	a1,56
ffffffffc02033e6:	00003517          	auipc	a0,0x3
ffffffffc02033ea:	8c250513          	addi	a0,a0,-1854 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
{
ffffffffc02033ee:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02033f0:	f85fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02033f4 <_clock_swap_out_victim>:
         assert(head != NULL);
ffffffffc02033f4:	751c                	ld	a5,40(a0)
{
...
ffffffffc02033fe:	e04a                	sd	s2,0(sp)
         assert(head != NULL);
ffffffffc0203400:	cbb5                	beqz	a5,ffffffffc0203474 <_clock_swap_out_victim+0x80>
     assert(in_tick==0);
ffffffffc0203402:	ea49                	bnez	a2,ffffffffc0203494 <_clock_swap_out_victim+0xa0>
ffffffffc0203404:	0000e497          	auipc	s1,0xe
ffffffffc0203408:	15448493          	addi	s1,s1,340 # ffffffffc0211558 <curr_ptr>
ffffffffc020340c:	6080                	ld	s0,0(s1)
    return listelm->next;
ffffffffc020340e:	0000e697          	auipc	a3,0xe
ffffffffc0203412:	cda68693          	addi	a3,a3,-806 # ffffffffc02110e8 <pra_list_head>
ffffffffc0203416:	6690                	ld	a2,8(a3)
ffffffffc0203418:	892e                	mv	s2,a1
ffffffffc020341a:	4701                	li	a4,0
        if(curr_ptr == &pra_list_head){
ffffffffc020341c:	00d40b63          	beq	s0,a3,ffffffffc0203432 <_clock_swap_out_victim+0x3e>
        if(ptr->visited){
ffffffffc0203420:	fe043783          	ld	a5,-32(s0)
ffffffffc0203424:	cf81                	beqz	a5,ffffffffc020343c <_clock_swap_out_victim+0x48>
            ptr->visited=0;
ffffffffc0203426:	fe043023          	sd	zero,-32(s0)
ffffffffc020342a:	6400                	ld	s0,8(s0)
    while (1) {
ffffffffc020342c:	4705                	li	a4,1
        if(curr_ptr == &pra_list_head){
ffffffffc020342e:	fed419e3          	bne	s0,a3,ffffffffc0203420 <_clock_swap_out_victim+0x2c>
            curr_ptr = list_next(curr_ptr);
ffffffffc0203432:	8432                	mv	s0,a2
        if(ptr->visited){
ffffffffc0203434:	fe043783          	ld	a5,-32(s0)
ffffffffc0203438:	4705                	li	a4,1
ffffffffc020343a:	f7f5                	bnez	a5,ffffffffc0203426 <_clock_swap_out_victim+0x32>
ffffffffc020343c:	c311                	beqz	a4,ffffffffc0203440 <_clock_swap_out_victim+0x4c>
ffffffffc020343e:	e080                	sd	s0,0(s1)
            cprintf("curr_ptr %p\n",curr_ptr);
ffffffffc0203440:	85a2                	mv	a1,s0
ffffffffc0203442:	00003517          	auipc	a0,0x3
ffffffffc0203446:	90e50513          	addi	a0,a0,-1778 # ffffffffc0205d50 <default_pmm_manager+0xac8>
ffffffffc020344a:	c71fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc020344e:	609c                	ld	a5,0(s1)
        struct Page *ptr = le2page(curr_ptr,pra_page_link);
ffffffffc0203450:	fd040413          	addi	s0,s0,-48
}
ffffffffc0203454:	60e2                	ld	ra,24(sp)
ffffffffc0203456:	6798                	ld	a4,8(a5)
ffffffffc0203458:	4501                	li	a0,0
            list_del(curr_ptr->prev);
ffffffffc020345a:	631c                	ld	a5,0(a4)
            curr_ptr = list_next(curr_ptr);
ffffffffc020345c:	e098                	sd	a4,0(s1)
}
ffffffffc020345e:	64a2                	ld	s1,8(sp)
    __list_del(listelm->prev, listelm->next);
ffffffffc0203460:	6398                	ld	a4,0(a5)
ffffffffc0203462:	679c                	ld	a5,8(a5)
    prev->next = next;
ffffffffc0203464:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203466:	e398                	sd	a4,0(a5)
            *ptr_page=ptr;
ffffffffc0203468:	00893023          	sd	s0,0(s2)
}
ffffffffc020346c:	6442                	ld	s0,16(sp)
ffffffffc020346e:	6902                	ld	s2,0(sp)
ffffffffc0203470:	6105                	addi	sp,sp,32
ffffffffc0203472:	8082                	ret
         assert(head != NULL);
ffffffffc0203474:	00003697          	auipc	a3,0x3
ffffffffc0203478:	8bc68693          	addi	a3,a3,-1860 # ffffffffc0205d30 <default_pmm_manager+0xaa8>
ffffffffc020347c:	00002617          	auipc	a2,0x2
ffffffffc0203480:	a5c60613          	addi	a2,a2,-1444 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203484:	04a00593          	li	a1,74
ffffffffc0203488:	00003517          	auipc	a0,0x3
ffffffffc020348c:	82050513          	addi	a0,a0,-2016 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc0203490:	ee5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc0203494:	00003697          	auipc	a3,0x3
ffffffffc0203498:	8ac68693          	addi	a3,a3,-1876 # ffffffffc0205d40 <default_pmm_manager+0xab8>
ffffffffc020349c:	00002617          	auipc	a2,0x2
ffffffffc02034a0:	a3c60613          	addi	a2,a2,-1476 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02034a4:	04b00593          	li	a1,75
ffffffffc02034a8:	00003517          	auipc	a0,0x3
ffffffffc02034ac:	80050513          	addi	a0,a0,-2048 # ffffffffc0205ca8 <default_pmm_manager+0xa20>
ffffffffc02034b0:	ec5fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034b4 <lru_pgfault>:
    }
    return 0;
}
...
ffffffffc02034b4:	7179                	addi	sp,sp,-48
ffffffffc02034b6:	ec26                	sd	s1,24(sp)
    cprintf("lru page fault at 0x%x\n", addr);// 打印页面错误信息
ffffffffc02034b8:	85b2                	mv	a1,a2
int lru_pgfault(struct mm_struct* mm, uint_t error_code, uintptr_t addr) {
ffffffffc02034ba:	84aa                	mv	s1,a0
    cprintf("lru page fault at 0x%x\n", addr);// 打印页面错误信息
ffffffffc02034bc:	00003517          	auipc	a0,0x3
ffffffffc02034c0:	8bc50513          	addi	a0,a0,-1860 # ffffffffc0205d78 <default_pmm_manager+0xaf0>
int lru_pgfault(struct mm_struct* mm, uint_t error_code, uintptr_t addr) {
ffffffffc02034c4:	e84a                	sd	s2,16(sp)
ffffffffc02034c6:	f406                	sd	ra,40(sp)
ffffffffc02034c8:	f022                	sd	s0,32(sp)
ffffffffc02034ca:	e44e                	sd	s3,8(sp)
ffffffffc02034cc:	8932                	mv	s2,a2
    cprintf("lru page fault at 0x%x\n", addr);// 打印页面错误信息
ffffffffc02034ce:	bedfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    // 如果已经初始化了交换空间，则设置所有页面不可读
    if (swap_init_ok)
ffffffffc02034d2:	0000e797          	auipc	a5,0xe
ffffffffc02034d6:	07e7a783          	lw	a5,126(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02034da:	ebc9                	bnez	a5,ffffffffc020356c <lru_pgfault+0xb8>
        unable_page_read(mm);
    // 获取页表项
    pte_t* ptep = NULL;
    ptep = get_pte(mm->pgdir, addr, 0);
ffffffffc02034dc:	6c88                	ld	a0,24(s1)
ffffffffc02034de:	4601                	li	a2,0
ffffffffc02034e0:	85ca                	mv	a1,s2
ffffffffc02034e2:	9eafe0ef          	jal	ra,ffffffffc02016cc <get_pte>
    *ptep |= PTE_R;// 设置页表项为可读
ffffffffc02034e6:	6114                	ld	a3,0(a0)
    if (!swap_init_ok)
ffffffffc02034e8:	0000e717          	auipc	a4,0xe
ffffffffc02034ec:	06872703          	lw	a4,104(a4) # ffffffffc0211550 <swap_init_ok>
    *ptep |= PTE_R;// 设置页表项为可读
ffffffffc02034f0:	0026e793          	ori	a5,a3,2
ffffffffc02034f4:	e11c                	sd	a5,0(a0)
    if (!swap_init_ok)
ffffffffc02034f6:	eb09                	bnez	a4,ffffffffc0203508 <lru_pgfault+0x54>
...
ffffffffc02034fa:	7402                	ld	s0,32(sp)
ffffffffc02034fc:	64e2                	ld	s1,24(sp)
ffffffffc02034fe:	6942                	ld	s2,16(sp)
ffffffffc0203500:	69a2                	ld	s3,8(sp)
ffffffffc0203502:	4501                	li	a0,0
ffffffffc0203504:	6145                	addi	sp,sp,48
ffffffffc0203506:	8082                	ret
    if (!(pte & PTE_V)) {
ffffffffc0203508:	8a85                	andi	a3,a3,1
ffffffffc020350a:	c2d9                	beqz	a3,ffffffffc0203590 <lru_pgfault+0xdc>
    return pa2page(PTE_ADDR(pte));
ffffffffc020350c:	078a                	slli	a5,a5,0x2
ffffffffc020350e:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203510:	0000e717          	auipc	a4,0xe
ffffffffc0203514:	01073703          	ld	a4,16(a4) # ffffffffc0211520 <npage>
ffffffffc0203518:	08e7f863          	bgeu	a5,a4,ffffffffc02035a8 <lru_pgfault+0xf4>
    return &pages[PPN(pa) - nbase];
ffffffffc020351c:	00003717          	auipc	a4,0x3
ffffffffc0203520:	e5473703          	ld	a4,-428(a4) # ffffffffc0206370 <nbase>
ffffffffc0203524:	8f99                	sub	a5,a5,a4
ffffffffc0203526:	00379613          	slli	a2,a5,0x3
    list_entry_t* head = (list_entry_t*)mm->sm_priv, * le = head;
ffffffffc020352a:	7494                	ld	a3,40(s1)
ffffffffc020352c:	97b2                	add	a5,a5,a2
ffffffffc020352e:	078e                	slli	a5,a5,0x3
ffffffffc0203530:	0000e617          	auipc	a2,0xe
ffffffffc0203534:	ff863603          	ld	a2,-8(a2) # ffffffffc0211528 <pages>
ffffffffc0203538:	963e                	add	a2,a2,a5
ffffffffc020353a:	87b6                	mv	a5,a3
    return listelm->prev;
ffffffffc020353c:	639c                	ld	a5,0(a5)
    while ((le = list_prev(le)) != head)
ffffffffc020353e:	faf68de3          	beq	a3,a5,ffffffffc02034f8 <lru_pgfault+0x44>
        struct Page* curr = le2page(le, pra_page_link);// 将链表节点转换为页面结构体
ffffffffc0203542:	fd078713          	addi	a4,a5,-48
        if (page == curr) {
ffffffffc0203546:	fee61be3          	bne	a2,a4,ffffffffc020353c <lru_pgfault+0x88>
    __list_del(listelm->prev, listelm->next);
ffffffffc020354a:	638c                	ld	a1,0(a5)
ffffffffc020354c:	6790                	ld	a2,8(a5)
}
ffffffffc020354e:	70a2                	ld	ra,40(sp)
ffffffffc0203550:	7402                	ld	s0,32(sp)
    prev->next = next;
ffffffffc0203552:	e590                	sd	a2,8(a1)
    __list_add(elm, listelm, listelm->next);
ffffffffc0203554:	6698                	ld	a4,8(a3)
    next->prev = prev;
ffffffffc0203556:	e20c                	sd	a1,0(a2)
ffffffffc0203558:	64e2                	ld	s1,24(sp)
    prev->next = next->prev = elm;
ffffffffc020355a:	e31c                	sd	a5,0(a4)
ffffffffc020355c:	e69c                	sd	a5,8(a3)
    elm->next = next;
ffffffffc020355e:	e798                	sd	a4,8(a5)
    elm->prev = prev;
ffffffffc0203560:	e394                	sd	a3,0(a5)
ffffffffc0203562:	6942                	ld	s2,16(sp)
ffffffffc0203564:	69a2                	ld	s3,8(sp)
ffffffffc0203566:	4501                	li	a0,0
ffffffffc0203568:	6145                	addi	sp,sp,48
ffffffffc020356a:	8082                	ret
    list_entry_t* head = (list_entry_t*)mm->sm_priv, * le = head;// 获取链表头节点
ffffffffc020356c:	0284b983          	ld	s3,40(s1)
    return listelm->prev;
ffffffffc0203570:	0009b403          	ld	s0,0(s3)
    while ((le = list_prev(le)) != head)// 遍历链表
ffffffffc0203574:	f68984e3          	beq	s3,s0,ffffffffc02034dc <lru_pgfault+0x28>
        ptep = get_pte(mm->pgdir, page->pra_vaddr, 0);// 获取页表项
ffffffffc0203578:	680c                	ld	a1,16(s0)
ffffffffc020357a:	6c88                	ld	a0,24(s1)
ffffffffc020357c:	4601                	li	a2,0
ffffffffc020357e:	94efe0ef          	jal	ra,ffffffffc02016cc <get_pte>
        *ptep &= ~PTE_R;// 清除页表项的可读权限
ffffffffc0203582:	611c                	ld	a5,0(a0)
ffffffffc0203584:	6000                	ld	s0,0(s0)
ffffffffc0203586:	9bf5                	andi	a5,a5,-3
ffffffffc0203588:	e11c                	sd	a5,0(a0)
    while ((le = list_prev(le)) != head)// 遍历链表
ffffffffc020358a:	fe8997e3          	bne	s3,s0,ffffffffc0203578 <lru_pgfault+0xc4>
ffffffffc020358e:	b7b9                	j	ffffffffc02034dc <lru_pgfault+0x28>
        panic("pte2page called with invalid pte");
ffffffffc0203590:	00002617          	auipc	a2,0x2
ffffffffc0203594:	d6060613          	addi	a2,a2,-672 # ffffffffc02052f0 <default_pmm_manager+0x68>
ffffffffc0203598:	07000593          	li	a1,112
ffffffffc020359c:	00002517          	auipc	a0,0x2
ffffffffc02035a0:	d4450513          	addi	a0,a0,-700 # ffffffffc02052e0 <default_pmm_manager+0x58>
ffffffffc02035a4:	dd1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02035a8:	00002617          	auipc	a2,0x2
ffffffffc02035ac:	d1860613          	addi	a2,a2,-744 # ffffffffc02052c0 <default_pmm_manager+0x38>
ffffffffc02035b0:	06500593          	li	a1,101
ffffffffc02035b4:	00002517          	auipc	a0,0x2
ffffffffc02035b8:	d2c50513          	addi	a0,a0,-724 # ffffffffc02052e0 <default_pmm_manager+0x58>
ffffffffc02035bc:	db9fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02035c0 <check_vma_overlap.part.0>:
}
...
ffffffffc02035c6:	7ce68693          	addi	a3,a3,1998 # ffffffffc0205d90 <default_pmm_manager+0xb08>
ffffffffc02035ca:	00002617          	auipc	a2,0x2
ffffffffc02035ce:	90e60613          	addi	a2,a2,-1778 # ffffffffc0204ed8 <commands+0x738>
ffffffffc02035d2:	07d00593          	li	a1,125
ffffffffc02035d6:	00002517          	auipc	a0,0x2
ffffffffc02035da:	7da50513          	addi	a0,a0,2010 # ffffffffc0205db0 <default_pmm_manager+0xb28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc02035de:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc02035e0:	d95fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02035e4 <mm_create>:
mm_create(void) {
ffffffffc02035e4:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02035e6:	03000513          	li	a0,48
mm_create(void) {
ffffffffc02035ea:	e022                	sd	s0,0(sp)
ffffffffc02035ec:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02035ee:	98aff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02035f2:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02035f4:	c105                	beqz	a0,ffffffffc0203614 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc02035f6:	e408                	sd	a0,8(s0)
ffffffffc02035f8:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
...
ffffffffc0203606:	0000e797          	auipc	a5,0xe
ffffffffc020360a:	f4a7a783          	lw	a5,-182(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc020360e:	eb81                	bnez	a5,ffffffffc020361e <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc0203610:	02053423          	sd	zero,40(a0)
}
...
ffffffffc020361c:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020361e:	967ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
ffffffffc0203622:	60a2                	ld	ra,8(sp)
ffffffffc0203624:	8522                	mv	a0,s0
ffffffffc0203626:	6402                	ld	s0,0(sp)
ffffffffc0203628:	0141                	addi	sp,sp,16
ffffffffc020362a:	8082                	ret

ffffffffc020362c <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc020362c:	1101                	addi	sp,sp,-32
ffffffffc020362e:	e04a                	sd	s2,0(sp)
ffffffffc0203630:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203632:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203636:	e822                	sd	s0,16(sp)
ffffffffc0203638:	e426                	sd	s1,8(sp)
ffffffffc020363a:	ec06                	sd	ra,24(sp)
ffffffffc020363c:	84ae                	mv	s1,a1
ffffffffc020363e:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203640:	938ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc0203644:	c509                	beqz	a0,ffffffffc020364e <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc0203646:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc020364a:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc020364c:	ed00                	sd	s0,24(a0)
}
ffffffffc020364e:	60e2                	ld	ra,24(sp)
ffffffffc0203650:	6442                	ld	s0,16(sp)
ffffffffc0203652:	64a2                	ld	s1,8(sp)
ffffffffc0203654:	6902                	ld	s2,0(sp)
ffffffffc0203656:	6105                	addi	sp,sp,32
ffffffffc0203658:	8082                	ret

ffffffffc020365a <find_vma>:
find_vma(struct mm_struct *mm, uintptr_t addr) {
ffffffffc020365a:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc020365c:	c505                	beqz	a0,ffffffffc0203684 <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc020365e:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203660:	c501                	beqz	a0,ffffffffc0203668 <find_vma+0xe>
ffffffffc0203662:	651c                	ld	a5,8(a0)
ffffffffc0203664:	02f5f263          	bgeu	a1,a5,ffffffffc0203688 <find_vma+0x2e>
    return listelm->next;
ffffffffc0203668:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc020366a:	00f68d63          	beq	a3,a5,ffffffffc0203684 <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc020366e:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203672:	00e5e663          	bltu	a1,a4,ffffffffc020367e <find_vma+0x24>
ffffffffc0203676:	ff07b703          	ld	a4,-16(a5)
ffffffffc020367a:	00e5ec63          	bltu	a1,a4,ffffffffc0203692 <find_vma+0x38>
ffffffffc020367e:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc0203680:	fef697e3          	bne	a3,a5,ffffffffc020366e <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc0203684:	4501                	li	a0,0
}
ffffffffc0203686:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203688:	691c                	ld	a5,16(a0)
ffffffffc020368a:	fcf5ffe3          	bgeu	a1,a5,ffffffffc0203668 <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc020368e:	ea88                	sd	a0,16(a3)
ffffffffc0203690:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc0203692:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc0203696:	ea88                	sd	a0,16(a3)
ffffffffc0203698:	8082                	ret

ffffffffc020369a <insert_vma_struct>:
...
ffffffffc020369a:	6590                	ld	a2,8(a1)
ffffffffc020369c:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc02036a0:	1141                	addi	sp,sp,-16
ffffffffc02036a2:	e406                	sd	ra,8(sp)
ffffffffc02036a4:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc02036a6:	01066763          	bltu	a2,a6,ffffffffc02036b4 <insert_vma_struct+0x1a>
ffffffffc02036aa:	a085                	j	ffffffffc020370a <insert_vma_struct+0x70>
...
ffffffffc02036b0:	04e66863          	bltu	a2,a4,ffffffffc0203700 <insert_vma_struct+0x66>
ffffffffc02036b4:	86be                	mv	a3,a5
ffffffffc02036b6:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02036b8:	fef51ae3          	bne	a0,a5,ffffffffc02036ac <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc02036bc:	02a68463          	beq	a3,a0,ffffffffc02036e4 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc02036c0:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc02036c4:	fe86b883          	ld	a7,-24(a3)
ffffffffc02036c8:	08e8f163          	bgeu	a7,a4,ffffffffc020374a <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02036cc:	04e66f63          	bltu	a2,a4,ffffffffc020372a <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc02036d0:	00f50a63          	beq	a0,a5,ffffffffc02036e4 <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc02036d4:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc02036d8:	05076963          	bltu	a4,a6,ffffffffc020372a <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc02036dc:	ff07b603          	ld	a2,-16(a5)
ffffffffc02036e0:	02c77363          	bgeu	a4,a2,ffffffffc0203706 <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc02036e4:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc02036e6:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc02036e8:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc02036ec:	e390                	sd	a2,0(a5)
ffffffffc02036ee:	e690                	sd	a2,8(a3)
}
ffffffffc02036f0:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc02036f2:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc02036f4:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc02036f6:	0017079b          	addiw	a5,a4,1
ffffffffc02036fa:	d11c                	sw	a5,32(a0)
}
ffffffffc02036fc:	0141                	addi	sp,sp,16
ffffffffc02036fe:	8082                	ret
    if (le_prev != list) {
ffffffffc0203700:	fca690e3          	bne	a3,a0,ffffffffc02036c0 <insert_vma_struct+0x26>
ffffffffc0203704:	bfd1                	j	ffffffffc02036d8 <insert_vma_struct+0x3e>
ffffffffc0203706:	ebbff0ef          	jal	ra,ffffffffc02035c0 <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc020370a:	00002697          	auipc	a3,0x2
ffffffffc020370e:	6b668693          	addi	a3,a3,1718 # ffffffffc0205dc0 <default_pmm_manager+0xb38>
ffffffffc0203712:	00001617          	auipc	a2,0x1
ffffffffc0203716:	7c660613          	addi	a2,a2,1990 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020371a:	08400593          	li	a1,132
ffffffffc020371e:	00002517          	auipc	a0,0x2
ffffffffc0203722:	69250513          	addi	a0,a0,1682 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203726:	c4ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020372a:	00002697          	auipc	a3,0x2
ffffffffc020372e:	6d668693          	addi	a3,a3,1750 # ffffffffc0205e00 <default_pmm_manager+0xb78>
ffffffffc0203732:	00001617          	auipc	a2,0x1
ffffffffc0203736:	7a660613          	addi	a2,a2,1958 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020373a:	07c00593          	li	a1,124
ffffffffc020373e:	00002517          	auipc	a0,0x2
ffffffffc0203742:	67250513          	addi	a0,a0,1650 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203746:	c2ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc020374a:	00002697          	auipc	a3,0x2
ffffffffc020374e:	69668693          	addi	a3,a3,1686 # ffffffffc0205de0 <default_pmm_manager+0xb58>
ffffffffc0203752:	00001617          	auipc	a2,0x1
ffffffffc0203756:	78660613          	addi	a2,a2,1926 # ffffffffc0204ed8 <commands+0x738>
ffffffffc020375a:	07b00593          	li	a1,123
ffffffffc020375e:	00002517          	auipc	a0,0x2
ffffffffc0203762:	65250513          	addi	a0,a0,1618 # ffffffffc0205db0 <default_pmm_manager+0xb28>
...
ffffffffc020376c:	e022                	sd	s0,0(sp)
ffffffffc020376e:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc0203770:	6508                	ld	a0,8(a0)
ffffffffc0203772:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc0203774:	00a40e63          	beq	s0,a0,ffffffffc0203790 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203778:	6118                	ld	a4,0(a0)
ffffffffc020377a:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc020377c:	03000593          	li	a1,48
ffffffffc0203780:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203782:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203784:	e398                	sd	a4,0(a5)
ffffffffc0203786:	8acff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020378a:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc020378c:	fea416e3          	bne	s0,a0,ffffffffc0203778 <mm_destroy+0xe>
    }
...
ffffffffc0203794:	60a2                	ld	ra,8(sp)
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203796:	03000593          	li	a1,48
}
ffffffffc020379a:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020379c:	896ff06f          	j	ffffffffc0202832 <kfree>

ffffffffc02037a0 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc02037a0:	715d                	addi	sp,sp,-80
ffffffffc02037a2:	e486                	sd	ra,72(sp)
ffffffffc02037a4:	f44e                	sd	s3,40(sp)
ffffffffc02037a6:	f052                	sd	s4,32(sp)
ffffffffc02037a8:	e0a2                	sd	s0,64(sp)
ffffffffc02037aa:	fc26                	sd	s1,56(sp)
ffffffffc02037ac:	f84a                	sd	s2,48(sp)
ffffffffc02037ae:	ec56                	sd	s5,24(sp)
ffffffffc02037b0:	e85a                	sd	s6,16(sp)
ffffffffc02037b2:	e45e                	sd	s7,8(sp)
}
...
ffffffffc02037b4:	edffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02037b8:	89aa                	mv	s3,a0
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc02037ba:	ed9fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
...
ffffffffc02037c4:	fb5fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc02037c8:	56050863          	beqz	a0,ffffffffc0203d38 <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc02037cc:	e508                	sd	a0,8(a0)
ffffffffc02037ce:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc02037d0:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02037d4:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02037d8:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02037dc:	0000e797          	auipc	a5,0xe
ffffffffc02037e0:	d747a783          	lw	a5,-652(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02037e4:	84aa                	mv	s1,a0
ffffffffc02037e6:	e7b9                	bnez	a5,ffffffffc0203834 <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc02037e8:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc02037ec:	03200413          	li	s0,50
ffffffffc02037f0:	a811                	j	ffffffffc0203804 <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc02037f2:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02037f4:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02037f6:	00053c23          	sd	zero,24(a0)
    assert(mm != NULL);
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc02037fa:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02037fc:	8526                	mv	a0,s1
ffffffffc02037fe:	e9dff0ef          	jal	ra,ffffffffc020369a <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc0203802:	cc05                	beqz	s0,ffffffffc020383a <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203804:	03000513          	li	a0,48
ffffffffc0203808:	f71fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020380c:	85aa                	mv	a1,a0
ffffffffc020380e:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203812:	f165                	bnez	a0,ffffffffc02037f2 <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc0203814:	00002697          	auipc	a3,0x2
ffffffffc0203818:	1a468693          	addi	a3,a3,420 # ffffffffc02059b8 <default_pmm_manager+0x730>
ffffffffc020381c:	00001617          	auipc	a2,0x1
ffffffffc0203820:	6bc60613          	addi	a2,a2,1724 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203824:	0ce00593          	li	a1,206
ffffffffc0203828:	00002517          	auipc	a0,0x2
ffffffffc020382c:	58850513          	addi	a0,a0,1416 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203830:	b45fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203834:	f50ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203838:	bf55                	j	ffffffffc02037ec <vmm_init+0x4c>
ffffffffc020383a:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020383e:	1f900913          	li	s2,505
ffffffffc0203842:	a819                	j	ffffffffc0203858 <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc0203844:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203846:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203848:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020384c:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc020384e:	8526                	mv	a0,s1
ffffffffc0203850:	e4bff0ef          	jal	ra,ffffffffc020369a <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203854:	03240a63          	beq	s0,s2,ffffffffc0203888 <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203858:	03000513          	li	a0,48
ffffffffc020385c:	f1dfe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203860:	85aa                	mv	a1,a0
ffffffffc0203862:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203866:	fd79                	bnez	a0,ffffffffc0203844 <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc0203868:	00002697          	auipc	a3,0x2
ffffffffc020386c:	15068693          	addi	a3,a3,336 # ffffffffc02059b8 <default_pmm_manager+0x730>
ffffffffc0203870:	00001617          	auipc	a2,0x1
ffffffffc0203874:	66860613          	addi	a2,a2,1640 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203878:	0d400593          	li	a1,212
ffffffffc020387c:	00002517          	auipc	a0,0x2
ffffffffc0203880:	53450513          	addi	a0,a0,1332 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203884:	af1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc0203888:	649c                	ld	a5,8(s1)
ffffffffc020388a:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc020388c:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc0203890:	2ef48463          	beq	s1,a5,ffffffffc0203b78 <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203894:	fe87b603          	ld	a2,-24(a5)
ffffffffc0203898:	ffe70693          	addi	a3,a4,-2
ffffffffc020389c:	26d61e63          	bne	a2,a3,ffffffffc0203b18 <vmm_init+0x378>
ffffffffc02038a0:	ff07b683          	ld	a3,-16(a5)
ffffffffc02038a4:	26e69a63          	bne	a3,a4,ffffffffc0203b18 <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc02038a8:	0715                	addi	a4,a4,5
ffffffffc02038aa:	679c                	ld	a5,8(a5)
ffffffffc02038ac:	feb712e3          	bne	a4,a1,ffffffffc0203890 <vmm_init+0xf0>
ffffffffc02038b0:	4b1d                	li	s6,7
ffffffffc02038b2:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc02038b4:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc02038b8:	85a2                	mv	a1,s0
ffffffffc02038ba:	8526                	mv	a0,s1
ffffffffc02038bc:	d9fff0ef          	jal	ra,ffffffffc020365a <find_vma>
ffffffffc02038c0:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc02038c2:	2c050b63          	beqz	a0,ffffffffc0203b98 <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc02038c6:	00140593          	addi	a1,s0,1
ffffffffc02038ca:	8526                	mv	a0,s1
ffffffffc02038cc:	d8fff0ef          	jal	ra,ffffffffc020365a <find_vma>
ffffffffc02038d0:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc02038d2:	2e050363          	beqz	a0,ffffffffc0203bb8 <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc02038d6:	85da                	mv	a1,s6
ffffffffc02038d8:	8526                	mv	a0,s1
ffffffffc02038da:	d81ff0ef          	jal	ra,ffffffffc020365a <find_vma>
        assert(vma3 == NULL);
ffffffffc02038de:	2e051d63          	bnez	a0,ffffffffc0203bd8 <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc02038e2:	00340593          	addi	a1,s0,3
ffffffffc02038e6:	8526                	mv	a0,s1
ffffffffc02038e8:	d73ff0ef          	jal	ra,ffffffffc020365a <find_vma>
        assert(vma4 == NULL);
ffffffffc02038ec:	30051663          	bnez	a0,ffffffffc0203bf8 <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc02038f0:	00440593          	addi	a1,s0,4
ffffffffc02038f4:	8526                	mv	a0,s1
ffffffffc02038f6:	d65ff0ef          	jal	ra,ffffffffc020365a <find_vma>
        assert(vma5 == NULL);
ffffffffc02038fa:	30051f63          	bnez	a0,ffffffffc0203c18 <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02038fe:	00893783          	ld	a5,8(s2)
ffffffffc0203902:	24879b63          	bne	a5,s0,ffffffffc0203b58 <vmm_init+0x3b8>
ffffffffc0203906:	01093783          	ld	a5,16(s2)
ffffffffc020390a:	25679763          	bne	a5,s6,ffffffffc0203b58 <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc020390e:	008ab783          	ld	a5,8(s5)
ffffffffc0203912:	22879363          	bne	a5,s0,ffffffffc0203b38 <vmm_init+0x398>
ffffffffc0203916:	010ab783          	ld	a5,16(s5)
ffffffffc020391a:	21679f63          	bne	a5,s6,ffffffffc0203b38 <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc020391e:	0415                	addi	s0,s0,5
ffffffffc0203920:	0b15                	addi	s6,s6,5
ffffffffc0203922:	f9741be3          	bne	s0,s7,ffffffffc02038b8 <vmm_init+0x118>
ffffffffc0203926:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc0203928:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc020392a:	85a2                	mv	a1,s0
ffffffffc020392c:	8526                	mv	a0,s1
ffffffffc020392e:	d2dff0ef          	jal	ra,ffffffffc020365a <find_vma>
ffffffffc0203932:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc0203936:	c90d                	beqz	a0,ffffffffc0203968 <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc0203938:	6914                	ld	a3,16(a0)
ffffffffc020393a:	6510                	ld	a2,8(a0)
ffffffffc020393c:	00002517          	auipc	a0,0x2
ffffffffc0203940:	5e450513          	addi	a0,a0,1508 # ffffffffc0205f20 <default_pmm_manager+0xc98>
ffffffffc0203944:	f76fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203948:	00002697          	auipc	a3,0x2
ffffffffc020394c:	60068693          	addi	a3,a3,1536 # ffffffffc0205f48 <default_pmm_manager+0xcc0>
ffffffffc0203950:	00001617          	auipc	a2,0x1
ffffffffc0203954:	58860613          	addi	a2,a2,1416 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203958:	0f600593          	li	a1,246
ffffffffc020395c:	00002517          	auipc	a0,0x2
ffffffffc0203960:	45450513          	addi	a0,a0,1108 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203964:	a11fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc0203968:	147d                	addi	s0,s0,-1
ffffffffc020396a:	fd2410e3          	bne	s0,s2,ffffffffc020392a <vmm_init+0x18a>
ffffffffc020396e:	a811                	j	ffffffffc0203982 <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
...
ffffffffc020397e:	eb5fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203982:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc0203984:	fea496e3          	bne	s1,a0,ffffffffc0203970 <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
...
ffffffffc0203996:	3caa1163          	bne	s4,a0,ffffffffc0203d58 <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc020399a:	00002517          	auipc	a0,0x2
ffffffffc020399e:	5ee50513          	addi	a0,a0,1518 # ffffffffc0205f88 <default_pmm_manager+0xd00>
...
ffffffffc02039b0:	dc9fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02039b4:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02039b6:	2a050163          	beqz	a0,ffffffffc0203c58 <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02039ba:	0000e797          	auipc	a5,0xe
ffffffffc02039be:	b967a783          	lw	a5,-1130(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc02039c2:	e508                	sd	a0,8(a0)
ffffffffc02039c4:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc02039c6:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02039ca:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02039ce:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02039d2:	14079063          	bnez	a5,ffffffffc0203b12 <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc02039d6:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02039da:	0000e917          	auipc	s2,0xe
ffffffffc02039de:	b3e93903          	ld	s2,-1218(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc02039e2:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc02039e6:	0000e717          	auipc	a4,0xe
ffffffffc02039ea:	b6873d23          	sd	s0,-1158(a4) # ffffffffc0211560 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02039ee:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc02039f2:	24079363          	bnez	a5,ffffffffc0203c38 <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02039f6:	03000513          	li	a0,48
ffffffffc02039fa:	d7ffe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02039fe:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc0203a00:	28050063          	beqz	a0,ffffffffc0203c80 <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc0203a04:	002007b7          	lui	a5,0x200
ffffffffc0203a08:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc0203a0c:	4789                	li	a5,2
...
ffffffffc0203a0e:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc0203a10:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203a14:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc0203a16:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203a1a:	c81ff0ef          	jal	ra,ffffffffc020369a <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc0203a1e:	10000593          	li	a1,256
ffffffffc0203a22:	8522                	mv	a0,s0
ffffffffc0203a24:	c37ff0ef          	jal	ra,ffffffffc020365a <find_vma>
ffffffffc0203a28:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc0203a2c:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc0203a30:	26aa1863          	bne	s4,a0,ffffffffc0203ca0 <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc0203a34:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc0203a38:	0785                	addi	a5,a5,1
ffffffffc0203a3a:	fee79de3          	bne	a5,a4,ffffffffc0203a34 <vmm_init+0x294>
        sum += i;
ffffffffc0203a3e:	6705                	lui	a4,0x1
ffffffffc0203a40:	10000793          	li	a5,256
ffffffffc0203a44:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc0203a48:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc0203a4c:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc0203a50:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc0203a52:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc0203a54:	fec79ce3          	bne	a5,a2,ffffffffc0203a4c <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc0203a58:	26071463          	bnez	a4,ffffffffc0203cc0 <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc0203a5c:	4581                	li	a1,0
ffffffffc0203a5e:	854a                	mv	a0,s2
ffffffffc0203a60:	ebdfd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203a64:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203a68:	0000e717          	auipc	a4,0xe
ffffffffc0203a6c:	ab873703          	ld	a4,-1352(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203a70:	078a                	slli	a5,a5,0x2
ffffffffc0203a72:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203a74:	26e7f663          	bgeu	a5,a4,ffffffffc0203ce0 <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc0203a78:	00003717          	auipc	a4,0x3
ffffffffc0203a7c:	8f873703          	ld	a4,-1800(a4) # ffffffffc0206370 <nbase>
ffffffffc0203a80:	8f99                	sub	a5,a5,a4
ffffffffc0203a82:	00379713          	slli	a4,a5,0x3
ffffffffc0203a86:	97ba                	add	a5,a5,a4
ffffffffc0203a88:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc0203a8a:	0000e517          	auipc	a0,0xe
ffffffffc0203a8e:	a9e53503          	ld	a0,-1378(a0) # ffffffffc0211528 <pages>
ffffffffc0203a92:	953e                	add	a0,a0,a5
ffffffffc0203a94:	4585                	li	a1,1
ffffffffc0203a96:	bbdfd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc0203a9a:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc0203a9c:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc0203aa0:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203aa4:	00a40e63          	beq	s0,a0,ffffffffc0203ac0 <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203aa8:	6118                	ld	a4,0(a0)
ffffffffc0203aaa:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203aac:	03000593          	li	a1,48
ffffffffc0203ab0:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203ab2:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203ab4:	e398                	sd	a4,0(a5)
ffffffffc0203ab6:	d7dfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203aba:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203abc:	fea416e3          	bne	s0,a0,ffffffffc0203aa8 <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203ac0:	03000593          	li	a1,48
ffffffffc0203ac4:	8522                	mv	a0,s0
ffffffffc0203ac6:	d6dfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc0203aca:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc0203acc:	0000e797          	auipc	a5,0xe
ffffffffc0203ad0:	a807ba23          	sd	zero,-1388(a5) # ffffffffc0211560 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203ad4:	bbffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203ad8:	22a49063          	bne	s1,a0,ffffffffc0203cf8 <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203adc:	00002517          	auipc	a0,0x2
ffffffffc0203ae0:	4fc50513          	addi	a0,a0,1276 # ffffffffc0205fd8 <default_pmm_manager+0xd50>
ffffffffc0203ae4:	dd6fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203ae8:	babfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc0203aec:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203aee:	22a99563          	bne	s3,a0,ffffffffc0203d18 <vmm_init+0x578>
}
ffffffffc0203af2:	6406                	ld	s0,64(sp)
ffffffffc0203af4:	60a6                	ld	ra,72(sp)
ffffffffc0203af6:	74e2                	ld	s1,56(sp)
ffffffffc0203af8:	7942                	ld	s2,48(sp)
ffffffffc0203afa:	79a2                	ld	s3,40(sp)
ffffffffc0203afc:	7a02                	ld	s4,32(sp)
ffffffffc0203afe:	6ae2                	ld	s5,24(sp)
ffffffffc0203b00:	6b42                	ld	s6,16(sp)
ffffffffc0203b02:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203b04:	00002517          	auipc	a0,0x2
ffffffffc0203b08:	4f450513          	addi	a0,a0,1268 # ffffffffc0205ff8 <default_pmm_manager+0xd70>
}
ffffffffc0203b0c:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203b0e:	dacfc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203b12:	c72ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203b16:	b5d1                	j	ffffffffc02039da <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203b18:	00002697          	auipc	a3,0x2
ffffffffc0203b1c:	32068693          	addi	a3,a3,800 # ffffffffc0205e38 <default_pmm_manager+0xbb0>
ffffffffc0203b20:	00001617          	auipc	a2,0x1
ffffffffc0203b24:	3b860613          	addi	a2,a2,952 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203b28:	0dd00593          	li	a1,221
ffffffffc0203b2c:	00002517          	auipc	a0,0x2
ffffffffc0203b30:	28450513          	addi	a0,a0,644 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203b34:	841fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203b38:	00002697          	auipc	a3,0x2
ffffffffc0203b3c:	3b868693          	addi	a3,a3,952 # ffffffffc0205ef0 <default_pmm_manager+0xc68>
ffffffffc0203b40:	00001617          	auipc	a2,0x1
ffffffffc0203b44:	39860613          	addi	a2,a2,920 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203b48:	0ee00593          	li	a1,238
ffffffffc0203b4c:	00002517          	auipc	a0,0x2
ffffffffc0203b50:	26450513          	addi	a0,a0,612 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203b54:	821fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203b58:	00002697          	auipc	a3,0x2
ffffffffc0203b5c:	36868693          	addi	a3,a3,872 # ffffffffc0205ec0 <default_pmm_manager+0xc38>
ffffffffc0203b60:	00001617          	auipc	a2,0x1
ffffffffc0203b64:	37860613          	addi	a2,a2,888 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203b68:	0ed00593          	li	a1,237
ffffffffc0203b6c:	00002517          	auipc	a0,0x2
ffffffffc0203b70:	24450513          	addi	a0,a0,580 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203b74:	801fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203b78:	00002697          	auipc	a3,0x2
ffffffffc0203b7c:	2a868693          	addi	a3,a3,680 # ffffffffc0205e20 <default_pmm_manager+0xb98>
ffffffffc0203b80:	00001617          	auipc	a2,0x1
ffffffffc0203b84:	35860613          	addi	a2,a2,856 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203b88:	0db00593          	li	a1,219
ffffffffc0203b8c:	00002517          	auipc	a0,0x2
ffffffffc0203b90:	22450513          	addi	a0,a0,548 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203b94:	fe0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203b98:	00002697          	auipc	a3,0x2
ffffffffc0203b9c:	2d868693          	addi	a3,a3,728 # ffffffffc0205e70 <default_pmm_manager+0xbe8>
ffffffffc0203ba0:	00001617          	auipc	a2,0x1
ffffffffc0203ba4:	33860613          	addi	a2,a2,824 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203ba8:	0e300593          	li	a1,227
ffffffffc0203bac:	00002517          	auipc	a0,0x2
ffffffffc0203bb0:	20450513          	addi	a0,a0,516 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203bb4:	fc0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203bb8:	00002697          	auipc	a3,0x2
ffffffffc0203bbc:	2c868693          	addi	a3,a3,712 # ffffffffc0205e80 <default_pmm_manager+0xbf8>
ffffffffc0203bc0:	00001617          	auipc	a2,0x1
ffffffffc0203bc4:	31860613          	addi	a2,a2,792 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203bc8:	0e500593          	li	a1,229
ffffffffc0203bcc:	00002517          	auipc	a0,0x2
ffffffffc0203bd0:	1e450513          	addi	a0,a0,484 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203bd4:	fa0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203bd8:	00002697          	auipc	a3,0x2
ffffffffc0203bdc:	2b868693          	addi	a3,a3,696 # ffffffffc0205e90 <default_pmm_manager+0xc08>
ffffffffc0203be0:	00001617          	auipc	a2,0x1
ffffffffc0203be4:	2f860613          	addi	a2,a2,760 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203be8:	0e700593          	li	a1,231
ffffffffc0203bec:	00002517          	auipc	a0,0x2
ffffffffc0203bf0:	1c450513          	addi	a0,a0,452 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203bf4:	f80fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203bf8:	00002697          	auipc	a3,0x2
ffffffffc0203bfc:	2a868693          	addi	a3,a3,680 # ffffffffc0205ea0 <default_pmm_manager+0xc18>
ffffffffc0203c00:	00001617          	auipc	a2,0x1
ffffffffc0203c04:	2d860613          	addi	a2,a2,728 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203c08:	0e900593          	li	a1,233
ffffffffc0203c0c:	00002517          	auipc	a0,0x2
ffffffffc0203c10:	1a450513          	addi	a0,a0,420 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203c14:	f60fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203c18:	00002697          	auipc	a3,0x2
ffffffffc0203c1c:	29868693          	addi	a3,a3,664 # ffffffffc0205eb0 <default_pmm_manager+0xc28>
ffffffffc0203c20:	00001617          	auipc	a2,0x1
ffffffffc0203c24:	2b860613          	addi	a2,a2,696 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203c28:	0eb00593          	li	a1,235
ffffffffc0203c2c:	00002517          	auipc	a0,0x2
ffffffffc0203c30:	18450513          	addi	a0,a0,388 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203c34:	f40fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203c38:	00002697          	auipc	a3,0x2
ffffffffc0203c3c:	d7068693          	addi	a3,a3,-656 # ffffffffc02059a8 <default_pmm_manager+0x720>
ffffffffc0203c40:	00001617          	auipc	a2,0x1
ffffffffc0203c44:	29860613          	addi	a2,a2,664 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203c48:	10d00593          	li	a1,269
ffffffffc0203c4c:	00002517          	auipc	a0,0x2
ffffffffc0203c50:	16450513          	addi	a0,a0,356 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203c54:	f20fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203c58:	00002697          	auipc	a3,0x2
ffffffffc0203c5c:	3b868693          	addi	a3,a3,952 # ffffffffc0206010 <default_pmm_manager+0xd88>
ffffffffc0203c60:	00001617          	auipc	a2,0x1
ffffffffc0203c64:	27860613          	addi	a2,a2,632 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203c68:	10a00593          	li	a1,266
ffffffffc0203c6c:	00002517          	auipc	a0,0x2
ffffffffc0203c70:	14450513          	addi	a0,a0,324 # ffffffffc0205db0 <default_pmm_manager+0xb28>
    check_mm_struct = mm_create();
ffffffffc0203c74:	0000e797          	auipc	a5,0xe
ffffffffc0203c78:	8e07b623          	sd	zero,-1812(a5) # ffffffffc0211560 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203c7c:	ef8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203c80:	00002697          	auipc	a3,0x2
ffffffffc0203c84:	d3868693          	addi	a3,a3,-712 # ffffffffc02059b8 <default_pmm_manager+0x730>
ffffffffc0203c88:	00001617          	auipc	a2,0x1
ffffffffc0203c8c:	25060613          	addi	a2,a2,592 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203c90:	11100593          	li	a1,273
ffffffffc0203c94:	00002517          	auipc	a0,0x2
ffffffffc0203c98:	11c50513          	addi	a0,a0,284 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203c9c:	ed8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203ca0:	00002697          	auipc	a3,0x2
ffffffffc0203ca4:	30868693          	addi	a3,a3,776 # ffffffffc0205fa8 <default_pmm_manager+0xd20>
ffffffffc0203ca8:	00001617          	auipc	a2,0x1
ffffffffc0203cac:	23060613          	addi	a2,a2,560 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203cb0:	11600593          	li	a1,278
ffffffffc0203cb4:	00002517          	auipc	a0,0x2
ffffffffc0203cb8:	0fc50513          	addi	a0,a0,252 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203cbc:	eb8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203cc0:	00002697          	auipc	a3,0x2
ffffffffc0203cc4:	30868693          	addi	a3,a3,776 # ffffffffc0205fc8 <default_pmm_manager+0xd40>
ffffffffc0203cc8:	00001617          	auipc	a2,0x1
ffffffffc0203ccc:	21060613          	addi	a2,a2,528 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203cd0:	12000593          	li	a1,288
ffffffffc0203cd4:	00002517          	auipc	a0,0x2
ffffffffc0203cd8:	0dc50513          	addi	a0,a0,220 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203cdc:	e98fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203ce0:	00001617          	auipc	a2,0x1
ffffffffc0203ce4:	5e060613          	addi	a2,a2,1504 # ffffffffc02052c0 <default_pmm_manager+0x38>
ffffffffc0203ce8:	06500593          	li	a1,101
ffffffffc0203cec:	00001517          	auipc	a0,0x1
ffffffffc0203cf0:	5f450513          	addi	a0,a0,1524 # ffffffffc02052e0 <default_pmm_manager+0x58>
ffffffffc0203cf4:	e80fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203cf8:	00002697          	auipc	a3,0x2
ffffffffc0203cfc:	26868693          	addi	a3,a3,616 # ffffffffc0205f60 <default_pmm_manager+0xcd8>
ffffffffc0203d00:	00001617          	auipc	a2,0x1
ffffffffc0203d04:	1d860613          	addi	a2,a2,472 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203d08:	12e00593          	li	a1,302
ffffffffc0203d0c:	00002517          	auipc	a0,0x2
ffffffffc0203d10:	0a450513          	addi	a0,a0,164 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203d14:	e60fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203d18:	00002697          	auipc	a3,0x2
ffffffffc0203d1c:	24868693          	addi	a3,a3,584 # ffffffffc0205f60 <default_pmm_manager+0xcd8>
ffffffffc0203d20:	00001617          	auipc	a2,0x1
ffffffffc0203d24:	1b860613          	addi	a2,a2,440 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203d28:	0bd00593          	li	a1,189
ffffffffc0203d2c:	00002517          	auipc	a0,0x2
ffffffffc0203d30:	08450513          	addi	a0,a0,132 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203d34:	e40fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203d38:	00002697          	auipc	a3,0x2
ffffffffc0203d3c:	c4868693          	addi	a3,a3,-952 # ffffffffc0205980 <default_pmm_manager+0x6f8>
ffffffffc0203d40:	00001617          	auipc	a2,0x1
ffffffffc0203d44:	19860613          	addi	a2,a2,408 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203d48:	0c700593          	li	a1,199
ffffffffc0203d4c:	00002517          	auipc	a0,0x2
ffffffffc0203d50:	06450513          	addi	a0,a0,100 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203d54:	e20fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203d58:	00002697          	auipc	a3,0x2
ffffffffc0203d5c:	20868693          	addi	a3,a3,520 # ffffffffc0205f60 <default_pmm_manager+0xcd8>
ffffffffc0203d60:	00001617          	auipc	a2,0x1
ffffffffc0203d64:	17860613          	addi	a2,a2,376 # ffffffffc0204ed8 <commands+0x738>
ffffffffc0203d68:	0fb00593          	li	a1,251
ffffffffc0203d6c:	00002517          	auipc	a0,0x2
ffffffffc0203d70:	04450513          	addi	a0,a0,68 # ffffffffc0205db0 <default_pmm_manager+0xb28>
ffffffffc0203d74:	e00fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d78 <do_pgfault>:
...
ffffffffc0203d7a:	f426                	sd	s1,40(sp)
ffffffffc0203d7c:	84aa                	mv	s1,a0
     
     pte_t* temp = NULL;
     temp = get_pte(mm->pgdir, addr, 0);
ffffffffc0203d7e:	6d08                	ld	a0,24(a0)
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203d80:	f822                	sd	s0,48(sp)
ffffffffc0203d82:	8432                	mv	s0,a2
ffffffffc0203d84:	f04a                	sd	s2,32(sp)
     temp = get_pte(mm->pgdir, addr, 0);
ffffffffc0203d86:	4601                	li	a2,0
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203d88:	892e                	mv	s2,a1
     temp = get_pte(mm->pgdir, addr, 0);
ffffffffc0203d8a:	85a2                	mv	a1,s0
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203d8c:	fc06                	sd	ra,56(sp)
ffffffffc0203d8e:	ec4e                	sd	s3,24(sp)
     temp = get_pte(mm->pgdir, addr, 0);
ffffffffc0203d90:	93dfd0ef          	jal	ra,ffffffffc02016cc <get_pte>
     if(temp != NULL && (*temp & (PTE_V | PTE_R))) {
ffffffffc0203d94:	c501                	beqz	a0,ffffffffc0203d9c <do_pgfault+0x24>
ffffffffc0203d96:	611c                	ld	a5,0(a0)
ffffffffc0203d98:	8b8d                	andi	a5,a5,3
ffffffffc0203d9a:	e3e9                	bnez	a5,ffffffffc0203e5c <do_pgfault+0xe4>
...
ffffffffc0203da0:	8bbff0ef          	jal	ra,ffffffffc020365a <find_vma>

    pgfault_num++;
ffffffffc0203da4:	0000d797          	auipc	a5,0xd
ffffffffc0203da8:	7c47a783          	lw	a5,1988(a5) # ffffffffc0211568 <pgfault_num>
ffffffffc0203dac:	2785                	addiw	a5,a5,1
ffffffffc0203dae:	0000d717          	auipc	a4,0xd
ffffffffc0203db2:	7af72d23          	sw	a5,1978(a4) # ffffffffc0211568 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203db6:	cd55                	beqz	a0,ffffffffc0203e72 <do_pgfault+0xfa>
ffffffffc0203db8:	651c                	ld	a5,8(a0)
ffffffffc0203dba:	0af46c63          	bltu	s0,a5,ffffffffc0203e72 <do_pgfault+0xfa>
...
ffffffffc0203dbe:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203dc0:	49c1                	li	s3,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203dc2:	8b89                	andi	a5,a5,2
ffffffffc0203dc4:	efa9                	bnez	a5,ffffffffc0203e1e <do_pgfault+0xa6>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203dc6:	767d                	lui	a2,0xfffff
...
ffffffffc0203dc8:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203dca:	8c71                	and	s0,s0,a2
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203dcc:	85a2                	mv	a1,s0
ffffffffc0203dce:	4605                	li	a2,1
ffffffffc0203dd0:	8fdfd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203dd4:	610c                	ld	a1,0(a0)
ffffffffc0203dd6:	c5b1                	beqz	a1,ffffffffc0203e22 <do_pgfault+0xaa>
...
ffffffffc0203ddc:	7787a783          	lw	a5,1912(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203de0:	c3d5                	beqz	a5,ffffffffc0203e84 <do_pgfault+0x10c>
...
ffffffffc0203de2:	0030                	addi	a2,sp,8
ffffffffc0203de4:	85a2                	mv	a1,s0
ffffffffc0203de6:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203de8:	e402                	sd	zero,8(sp)
            ret = swap_in(mm, addr, &page);
ffffffffc0203dea:	ac6ff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
ffffffffc0203dee:	892a                	mv	s2,a0
            if (ret != 0) {
ffffffffc0203df0:	e921                	bnez	a0,ffffffffc0203e40 <do_pgfault+0xc8>
...
ffffffffc0203df2:	65a2                	ld	a1,8(sp)
ffffffffc0203df4:	6c88                	ld	a0,24(s1)
ffffffffc0203df6:	86ce                	mv	a3,s3
ffffffffc0203df8:	8622                	mv	a2,s0
ffffffffc0203dfa:	bbdfd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
            //(3) make the page swappable.
            // 设置当前的物理页为可交换页
            swap_map_swappable(mm,addr,page,1);
ffffffffc0203dfe:	6622                	ld	a2,8(sp)
ffffffffc0203e00:	4685                	li	a3,1
ffffffffc0203e02:	85a2                	mv	a1,s0
ffffffffc0203e04:	8526                	mv	a0,s1
ffffffffc0203e06:	98aff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0203e0a:	67a2                	ld	a5,8(sp)
ffffffffc0203e0c:	e3a0                	sd	s0,64(a5)
   }
...
ffffffffc0203e10:	7442                	ld	s0,48(sp)
ffffffffc0203e12:	74a2                	ld	s1,40(sp)
ffffffffc0203e14:	69e2                	ld	s3,24(sp)
ffffffffc0203e16:	854a                	mv	a0,s2
ffffffffc0203e18:	7902                	ld	s2,32(sp)
ffffffffc0203e1a:	6121                	addi	sp,sp,64
ffffffffc0203e1c:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203e1e:	49d9                	li	s3,22
ffffffffc0203e20:	b75d                	j	ffffffffc0203dc6 <do_pgfault+0x4e>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203e22:	6c88                	ld	a0,24(s1)
ffffffffc0203e24:	864e                	mv	a2,s3
ffffffffc0203e26:	85a2                	mv	a1,s0
ffffffffc0203e28:	899fe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
   ret = 0;
ffffffffc0203e2c:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203e2e:	f165                	bnez	a0,ffffffffc0203e0e <do_pgfault+0x96>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203e30:	00002517          	auipc	a0,0x2
ffffffffc0203e34:	22850513          	addi	a0,a0,552 # ffffffffc0206058 <default_pmm_manager+0xdd0>
ffffffffc0203e38:	a82fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203e3c:	5971                	li	s2,-4
            goto failed;
ffffffffc0203e3e:	bfc1                	j	ffffffffc0203e0e <do_pgfault+0x96>
                cprintf("swap_in in do_pgfault failed\n");
ffffffffc0203e40:	00002517          	auipc	a0,0x2
ffffffffc0203e44:	24050513          	addi	a0,a0,576 # ffffffffc0206080 <default_pmm_manager+0xdf8>
ffffffffc0203e48:	a72fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0203e4c:	70e2                	ld	ra,56(sp)
ffffffffc0203e4e:	7442                	ld	s0,48(sp)
ffffffffc0203e50:	74a2                	ld	s1,40(sp)
ffffffffc0203e52:	69e2                	ld	s3,24(sp)
ffffffffc0203e54:	854a                	mv	a0,s2
ffffffffc0203e56:	7902                	ld	s2,32(sp)
ffffffffc0203e58:	6121                	addi	sp,sp,64
ffffffffc0203e5a:	8082                	ret
         return lru_pgfault(mm, error_code, addr);
ffffffffc0203e5c:	8622                	mv	a2,s0
}
ffffffffc0203e5e:	7442                	ld	s0,48(sp)
ffffffffc0203e60:	70e2                	ld	ra,56(sp)
ffffffffc0203e62:	69e2                	ld	s3,24(sp)
         return lru_pgfault(mm, error_code, addr);
ffffffffc0203e64:	85ca                	mv	a1,s2
ffffffffc0203e66:	8526                	mv	a0,s1
}
ffffffffc0203e68:	7902                	ld	s2,32(sp)
ffffffffc0203e6a:	74a2                	ld	s1,40(sp)
ffffffffc0203e6c:	6121                	addi	sp,sp,64
         return lru_pgfault(mm, error_code, addr);
ffffffffc0203e6e:	e46ff06f          	j	ffffffffc02034b4 <lru_pgfault>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203e72:	85a2                	mv	a1,s0
ffffffffc0203e74:	00002517          	auipc	a0,0x2
ffffffffc0203e78:	1b450513          	addi	a0,a0,436 # ffffffffc0206028 <default_pmm_manager+0xda0>
ffffffffc0203e7c:	a3efc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203e80:	5975                	li	s2,-3
        goto failed;
ffffffffc0203e82:	b771                	j	ffffffffc0203e0e <do_pgfault+0x96>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203e84:	00002517          	auipc	a0,0x2
ffffffffc0203e88:	21c50513          	addi	a0,a0,540 # ffffffffc02060a0 <default_pmm_manager+0xe18>
ffffffffc0203e8c:	a2efc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203e90:	5971                	li	s2,-4
            goto failed;
ffffffffc0203e92:	bfb5                	j	ffffffffc0203e0e <do_pgfault+0x96>

ffffffffc0203e94 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc0203e98:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203e9a:	dfafc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203e9e:	cd01                	beqz	a0,ffffffffc0203eb6 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203ea0:	4505                	li	a0,1
ffffffffc0203ea2:	df8fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203ea6:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203ea8:	810d                	srli	a0,a0,0x3
ffffffffc0203eaa:	0000d797          	auipc	a5,0xd
ffffffffc0203eae:	68a7bb23          	sd	a0,1686(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203eb2:	0141                	addi	sp,sp,16
ffffffffc0203eb4:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203eb6:	00002617          	auipc	a2,0x2
ffffffffc0203eba:	21260613          	addi	a2,a2,530 # ffffffffc02060c8 <default_pmm_manager+0xe40>
ffffffffc0203ebe:	45b5                	li	a1,13
ffffffffc0203ec0:	00002517          	auipc	a0,0x2
ffffffffc0203ec4:	22850513          	addi	a0,a0,552 # ffffffffc02060e8 <default_pmm_manager+0xe60>
ffffffffc0203ec8:	cacfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203ecc <swapfs_read>:
...
ffffffffc0203ed0:	00855793          	srli	a5,a0,0x8
ffffffffc0203ed4:	c3a5                	beqz	a5,ffffffffc0203f34 <swapfs_read+0x68>
ffffffffc0203ed6:	0000d717          	auipc	a4,0xd
ffffffffc0203eda:	66a73703          	ld	a4,1642(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203ede:	04e7fb63          	bgeu	a5,a4,ffffffffc0203f34 <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203ee2:	0000d617          	auipc	a2,0xd
ffffffffc0203ee6:	64663603          	ld	a2,1606(a2) # ffffffffc0211528 <pages>
ffffffffc0203eea:	8d91                	sub	a1,a1,a2
ffffffffc0203eec:	4035d613          	srai	a2,a1,0x3
ffffffffc0203ef0:	00002597          	auipc	a1,0x2
ffffffffc0203ef4:	4785b583          	ld	a1,1144(a1) # ffffffffc0206368 <error_string+0x38>
ffffffffc0203ef8:	02b60633          	mul	a2,a2,a1
ffffffffc0203efc:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203f00:	00002797          	auipc	a5,0x2
ffffffffc0203f04:	4707b783          	ld	a5,1136(a5) # ffffffffc0206370 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203f08:	0000d717          	auipc	a4,0xd
ffffffffc0203f0c:	61873703          	ld	a4,1560(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203f10:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203f12:	00c61793          	slli	a5,a2,0xc
ffffffffc0203f16:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203f18:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203f1a:	02e7f963          	bgeu	a5,a4,ffffffffc0203f4c <swapfs_read+0x80>
}
ffffffffc0203f1e:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203f20:	0000d797          	auipc	a5,0xd
ffffffffc0203f24:	6187b783          	ld	a5,1560(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203f28:	46a1                	li	a3,8
ffffffffc0203f2a:	963e                	add	a2,a2,a5
ffffffffc0203f2c:	4505                	li	a0,1
}
ffffffffc0203f2e:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203f30:	d70fc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203f34:	86aa                	mv	a3,a0
ffffffffc0203f36:	00002617          	auipc	a2,0x2
ffffffffc0203f3a:	1ca60613          	addi	a2,a2,458 # ffffffffc0206100 <default_pmm_manager+0xe78>
ffffffffc0203f3e:	45d1                	li	a1,20
ffffffffc0203f40:	00002517          	auipc	a0,0x2
ffffffffc0203f44:	1a850513          	addi	a0,a0,424 # ffffffffc02060e8 <default_pmm_manager+0xe60>
ffffffffc0203f48:	c2cfc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203f4c:	86b2                	mv	a3,a2
ffffffffc0203f4e:	06a00593          	li	a1,106
ffffffffc0203f52:	00001617          	auipc	a2,0x1
ffffffffc0203f56:	3c660613          	addi	a2,a2,966 # ffffffffc0205318 <default_pmm_manager+0x90>
ffffffffc0203f5a:	00001517          	auipc	a0,0x1
ffffffffc0203f5e:	38650513          	addi	a0,a0,902 # ffffffffc02052e0 <default_pmm_manager+0x58>
ffffffffc0203f62:	c12fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203f66 <swapfs_write>:
...
ffffffffc0203f6e:	c3a5                	beqz	a5,ffffffffc0203fce <swapfs_write+0x68>
ffffffffc0203f70:	0000d717          	auipc	a4,0xd
ffffffffc0203f74:	5d073703          	ld	a4,1488(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203f78:	04e7fb63          	bgeu	a5,a4,ffffffffc0203fce <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203f7c:	0000d617          	auipc	a2,0xd
ffffffffc0203f80:	5ac63603          	ld	a2,1452(a2) # ffffffffc0211528 <pages>
ffffffffc0203f84:	8d91                	sub	a1,a1,a2
ffffffffc0203f86:	4035d613          	srai	a2,a1,0x3
ffffffffc0203f8a:	00002597          	auipc	a1,0x2
ffffffffc0203f8e:	3de5b583          	ld	a1,990(a1) # ffffffffc0206368 <error_string+0x38>
ffffffffc0203f92:	02b60633          	mul	a2,a2,a1
ffffffffc0203f96:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203f9a:	00002797          	auipc	a5,0x2
ffffffffc0203f9e:	3d67b783          	ld	a5,982(a5) # ffffffffc0206370 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203fa2:	0000d717          	auipc	a4,0xd
ffffffffc0203fa6:	57e73703          	ld	a4,1406(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203faa:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203fac:	00c61793          	slli	a5,a2,0xc
ffffffffc0203fb0:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203fb2:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203fb4:	02e7f963          	bgeu	a5,a4,ffffffffc0203fe6 <swapfs_write+0x80>
}
ffffffffc0203fb8:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203fba:	0000d797          	auipc	a5,0xd
ffffffffc0203fbe:	57e7b783          	ld	a5,1406(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203fc2:	46a1                	li	a3,8
ffffffffc0203fc4:	963e                	add	a2,a2,a5
ffffffffc0203fc6:	4505                	li	a0,1
}
ffffffffc0203fc8:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203fca:	cfafc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203fce:	86aa                	mv	a3,a0
ffffffffc0203fd0:	00002617          	auipc	a2,0x2
ffffffffc0203fd4:	13060613          	addi	a2,a2,304 # ffffffffc0206100 <default_pmm_manager+0xe78>
ffffffffc0203fd8:	45e5                	li	a1,25
ffffffffc0203fda:	00002517          	auipc	a0,0x2
ffffffffc0203fde:	10e50513          	addi	a0,a0,270 # ffffffffc02060e8 <default_pmm_manager+0xe60>
ffffffffc0203fe2:	b92fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203fe6:	86b2                	mv	a3,a2
ffffffffc0203fe8:	06a00593          	li	a1,106
ffffffffc0203fec:	00001617          	auipc	a2,0x1
ffffffffc0203ff0:	32c60613          	addi	a2,a2,812 # ffffffffc0205318 <default_pmm_manager+0x90>
ffffffffc0203ff4:	00001517          	auipc	a0,0x1
ffffffffc0203ff8:	2ec50513          	addi	a0,a0,748 # ffffffffc02052e0 <default_pmm_manager+0x58>
ffffffffc0203ffc:	b78fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0204000 <printnum>:
 * */
static void
...
ffffffffc0204000:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204004:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204006:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020400a:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc020400c:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204010:	f022                	sd	s0,32(sp)
ffffffffc0204012:	ec26                	sd	s1,24(sp)
...
ffffffffc020401c:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc020401e:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204022:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204024:	03067e63          	bgeu	a2,a6,ffffffffc0204060 <printnum+0x60>
ffffffffc0204028:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc020402a:	00805763          	blez	s0,ffffffffc0204038 <printnum+0x38>
ffffffffc020402e:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204030:	85ca                	mv	a1,s2
ffffffffc0204032:	854e                	mv	a0,s3
ffffffffc0204034:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204036:	fc65                	bnez	s0,ffffffffc020402e <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204038:	1a02                	slli	s4,s4,0x20
ffffffffc020403a:	00002797          	auipc	a5,0x2
ffffffffc020403e:	0e678793          	addi	a5,a5,230 # ffffffffc0206120 <default_pmm_manager+0xe98>
ffffffffc0204042:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204046:	9a3e                	add	s4,s4,a5
}
ffffffffc0204048:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020404a:	000a4503          	lbu	a0,0(s4)
}
ffffffffc020404e:	70a2                	ld	ra,40(sp)
ffffffffc0204050:	69a2                	ld	s3,8(sp)
ffffffffc0204052:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204054:	85ca                	mv	a1,s2
ffffffffc0204056:	87a6                	mv	a5,s1
}
ffffffffc0204058:	6942                	ld	s2,16(sp)
ffffffffc020405a:	64e2                	ld	s1,24(sp)
ffffffffc020405c:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020405e:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204060:	03065633          	divu	a2,a2,a6
ffffffffc0204064:	8722                	mv	a4,s0
ffffffffc0204066:	f9bff0ef          	jal	ra,ffffffffc0204000 <printnum>
ffffffffc020406a:	b7f9                	j	ffffffffc0204038 <printnum+0x38>

ffffffffc020406c <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc020406c:	7119                	addi	sp,sp,-128
ffffffffc020406e:	f4a6                	sd	s1,104(sp)
ffffffffc0204070:	f0ca                	sd	s2,96(sp)
ffffffffc0204072:	ecce                	sd	s3,88(sp)
ffffffffc0204074:	e8d2                	sd	s4,80(sp)
ffffffffc0204076:	e4d6                	sd	s5,72(sp)
ffffffffc0204078:	e0da                	sd	s6,64(sp)
ffffffffc020407a:	fc5e                	sd	s7,56(sp)
ffffffffc020407c:	f06a                	sd	s10,32(sp)
ffffffffc020407e:	fc86                	sd	ra,120(sp)
ffffffffc0204080:	f8a2                	sd	s0,112(sp)
ffffffffc0204082:	f862                	sd	s8,48(sp)
ffffffffc0204084:	f466                	sd	s9,40(sp)
ffffffffc0204086:	ec6e                	sd	s11,24(sp)
ffffffffc0204088:	892a                	mv	s2,a0
ffffffffc020408a:	84ae                	mv	s1,a1
ffffffffc020408c:	8d32                	mv	s10,a2
ffffffffc020408e:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204090:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204094:	5b7d                	li	s6,-1
ffffffffc0204096:	00002a97          	auipc	s5,0x2
ffffffffc020409a:	0bea8a93          	addi	s5,s5,190 # ffffffffc0206154 <default_pmm_manager+0xecc>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc020409e:	00002b97          	auipc	s7,0x2
ffffffffc02040a2:	292b8b93          	addi	s7,s7,658 # ffffffffc0206330 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02040a6:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc02040aa:	001d0413          	addi	s0,s10,1
ffffffffc02040ae:	01350a63          	beq	a0,s3,ffffffffc02040c2 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc02040b2:	c121                	beqz	a0,ffffffffc02040f2 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc02040b4:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02040b6:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc02040b8:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02040ba:	fff44503          	lbu	a0,-1(s0)
ffffffffc02040be:	ff351ae3          	bne	a0,s3,ffffffffc02040b2 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040c2:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc02040c6:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc02040ca:	4c81                	li	s9,0
ffffffffc02040cc:	4881                	li	a7,0
        width = precision = -1;
ffffffffc02040ce:	5c7d                	li	s8,-1
ffffffffc02040d0:	5dfd                	li	s11,-1
ffffffffc02040d2:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc02040d6:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040d8:	fdd6059b          	addiw	a1,a2,-35
ffffffffc02040dc:	0ff5f593          	andi	a1,a1,255
ffffffffc02040e0:	00140d13          	addi	s10,s0,1
ffffffffc02040e4:	04b56263          	bltu	a0,a1,ffffffffc0204128 <vprintfmt+0xbc>
ffffffffc02040e8:	058a                	slli	a1,a1,0x2
ffffffffc02040ea:	95d6                	add	a1,a1,s5
ffffffffc02040ec:	4194                	lw	a3,0(a1)
ffffffffc02040ee:	96d6                	add	a3,a3,s5
ffffffffc02040f0:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc02040f2:	70e6                	ld	ra,120(sp)
ffffffffc02040f4:	7446                	ld	s0,112(sp)
ffffffffc02040f6:	74a6                	ld	s1,104(sp)
ffffffffc02040f8:	7906                	ld	s2,96(sp)
ffffffffc02040fa:	69e6                	ld	s3,88(sp)
ffffffffc02040fc:	6a46                	ld	s4,80(sp)
ffffffffc02040fe:	6aa6                	ld	s5,72(sp)
ffffffffc0204100:	6b06                	ld	s6,64(sp)
ffffffffc0204102:	7be2                	ld	s7,56(sp)
ffffffffc0204104:	7c42                	ld	s8,48(sp)
ffffffffc0204106:	7ca2                	ld	s9,40(sp)
ffffffffc0204108:	7d02                	ld	s10,32(sp)
ffffffffc020410a:	6de2                	ld	s11,24(sp)
ffffffffc020410c:	6109                	addi	sp,sp,128
ffffffffc020410e:	8082                	ret
            padc = '0';
ffffffffc0204110:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204112:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204116:	846a                	mv	s0,s10
ffffffffc0204118:	00140d13          	addi	s10,s0,1
ffffffffc020411c:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204120:	0ff5f593          	andi	a1,a1,255
ffffffffc0204124:	fcb572e3          	bgeu	a0,a1,ffffffffc02040e8 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204128:	85a6                	mv	a1,s1
ffffffffc020412a:	02500513          	li	a0,37
ffffffffc020412e:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204130:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204134:	8d22                	mv	s10,s0
ffffffffc0204136:	f73788e3          	beq	a5,s3,ffffffffc02040a6 <vprintfmt+0x3a>
ffffffffc020413a:	ffed4783          	lbu	a5,-2(s10)
ffffffffc020413e:	1d7d                	addi	s10,s10,-1
ffffffffc0204140:	ff379de3          	bne	a5,s3,ffffffffc020413a <vprintfmt+0xce>
ffffffffc0204144:	b78d                	j	ffffffffc02040a6 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204146:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
...
ffffffffc0204154:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204158:	02d86463          	bltu	a6,a3,ffffffffc0204180 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc020415c:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204160:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204164:	0186873b          	addw	a4,a3,s8
ffffffffc0204168:	0017171b          	slliw	a4,a4,0x1
ffffffffc020416c:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc020416e:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204172:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204174:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204178:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020417c:	fed870e3          	bgeu	a6,a3,ffffffffc020415c <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204180:	f40ddce3          	bgez	s11,ffffffffc02040d8 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204184:	8de2                	mv	s11,s8
ffffffffc0204186:	5c7d                	li	s8,-1
ffffffffc0204188:	bf81                	j	ffffffffc02040d8 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc020418a:	fffdc693          	not	a3,s11
ffffffffc020418e:	96fd                	srai	a3,a3,0x3f
ffffffffc0204190:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204194:	00144603          	lbu	a2,1(s0)
ffffffffc0204198:	2d81                	sext.w	s11,s11
ffffffffc020419a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020419c:	bf35                	j	ffffffffc02040d8 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc020419e:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc02041aa:	bfd9                	j	ffffffffc0204180 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc02041ac:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02041ae:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02041b2:	01174463          	blt	a4,a7,ffffffffc02041ba <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc02041b6:	1a088e63          	beqz	a7,ffffffffc0204372 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc02041ba:	000a3603          	ld	a2,0(s4)
ffffffffc02041be:	46c1                	li	a3,16
ffffffffc02041c0:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc02041c2:	2781                	sext.w	a5,a5
ffffffffc02041c4:	876e                	mv	a4,s11
ffffffffc02041c6:	85a6                	mv	a1,s1
ffffffffc02041c8:	854a                	mv	a0,s2
ffffffffc02041ca:	e37ff0ef          	jal	ra,ffffffffc0204000 <printnum>
            break;
ffffffffc02041ce:	bde1                	j	ffffffffc02040a6 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc02041d0:	000a2503          	lw	a0,0(s4)
ffffffffc02041d4:	85a6                	mv	a1,s1
ffffffffc02041d6:	0a21                	addi	s4,s4,8
ffffffffc02041d8:	9902                	jalr	s2
            break;
ffffffffc02041da:	b5f1                	j	ffffffffc02040a6 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02041dc:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02041de:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02041e2:	01174463          	blt	a4,a7,ffffffffc02041ea <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc02041e6:	18088163          	beqz	a7,ffffffffc0204368 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc02041ea:	000a3603          	ld	a2,0(s4)
ffffffffc02041ee:	46a9                	li	a3,10
ffffffffc02041f0:	8a2e                	mv	s4,a1
ffffffffc02041f2:	bfc1                	j	ffffffffc02041c2 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02041f4:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc02041f8:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02041fa:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02041fc:	bdf1                	j	ffffffffc02040d8 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc02041fe:	85a6                	mv	a1,s1
ffffffffc0204200:	02500513          	li	a0,37
ffffffffc0204204:	9902                	jalr	s2
            break;
ffffffffc0204206:	b545                	j	ffffffffc02040a6 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204208:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc020420c:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020420e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204210:	b5e1                	j	ffffffffc02040d8 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204212:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204214:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204218:	01174463          	blt	a4,a7,ffffffffc0204220 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc020421c:	14088163          	beqz	a7,ffffffffc020435e <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204220:	000a3603          	ld	a2,0(s4)
ffffffffc0204224:	46a1                	li	a3,8
ffffffffc0204226:	8a2e                	mv	s4,a1
ffffffffc0204228:	bf69                	j	ffffffffc02041c2 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc020422a:	03000513          	li	a0,48
...
ffffffffc0204236:	07800513          	li	a0,120
ffffffffc020423a:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020423c:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc020423e:	6782                	ld	a5,0(sp)
ffffffffc0204240:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204242:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204246:	bfb5                	j	ffffffffc02041c2 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204248:	000a3403          	ld	s0,0(s4)
ffffffffc020424c:	008a0713          	addi	a4,s4,8
ffffffffc0204250:	e03a                	sd	a4,0(sp)
ffffffffc0204252:	14040263          	beqz	s0,ffffffffc0204396 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204256:	0fb05763          	blez	s11,ffffffffc0204344 <vprintfmt+0x2d8>
ffffffffc020425a:	02d00693          	li	a3,45
ffffffffc020425e:	0cd79163          	bne	a5,a3,ffffffffc0204320 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204262:	00044783          	lbu	a5,0(s0)
ffffffffc0204266:	0007851b          	sext.w	a0,a5
ffffffffc020426a:	cf85                	beqz	a5,ffffffffc02042a2 <vprintfmt+0x236>
ffffffffc020426c:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204270:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204274:	000c4563          	bltz	s8,ffffffffc020427e <vprintfmt+0x212>
ffffffffc0204278:	3c7d                	addiw	s8,s8,-1
ffffffffc020427a:	036c0263          	beq	s8,s6,ffffffffc020429e <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc020427e:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204280:	0e0c8e63          	beqz	s9,ffffffffc020437c <vprintfmt+0x310>
ffffffffc0204284:	3781                	addiw	a5,a5,-32
ffffffffc0204286:	0ef47b63          	bgeu	s0,a5,ffffffffc020437c <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc020428a:	03f00513          	li	a0,63
ffffffffc020428e:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204290:	000a4783          	lbu	a5,0(s4)
ffffffffc0204294:	3dfd                	addiw	s11,s11,-1
ffffffffc0204296:	0a05                	addi	s4,s4,1
ffffffffc0204298:	0007851b          	sext.w	a0,a5
ffffffffc020429c:	ffe1                	bnez	a5,ffffffffc0204274 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc020429e:	01b05963          	blez	s11,ffffffffc02042b0 <vprintfmt+0x244>
ffffffffc02042a2:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02042a4:	85a6                	mv	a1,s1
ffffffffc02042a6:	02000513          	li	a0,32
ffffffffc02042aa:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02042ac:	fe0d9be3          	bnez	s11,ffffffffc02042a2 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02042b0:	6a02                	ld	s4,0(sp)
ffffffffc02042b2:	bbd5                	j	ffffffffc02040a6 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02042b4:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02042b6:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02042ba:	01174463          	blt	a4,a7,ffffffffc02042c2 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02042be:	08088d63          	beqz	a7,ffffffffc0204358 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02042c2:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02042c6:	0a044d63          	bltz	s0,ffffffffc0204380 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02042ca:	8622                	mv	a2,s0
ffffffffc02042cc:	8a66                	mv	s4,s9
ffffffffc02042ce:	46a9                	li	a3,10
ffffffffc02042d0:	bdcd                	j	ffffffffc02041c2 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc02042d2:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02042d6:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc02042d8:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc02042da:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc02042de:	8fb5                	xor	a5,a5,a3
ffffffffc02042e0:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02042e4:	02d74163          	blt	a4,a3,ffffffffc0204306 <vprintfmt+0x29a>
ffffffffc02042e8:	00369793          	slli	a5,a3,0x3
ffffffffc02042ec:	97de                	add	a5,a5,s7
ffffffffc02042ee:	639c                	ld	a5,0(a5)
ffffffffc02042f0:	cb99                	beqz	a5,ffffffffc0204306 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc02042f2:	86be                	mv	a3,a5
ffffffffc02042f4:	00002617          	auipc	a2,0x2
ffffffffc02042f8:	e5c60613          	addi	a2,a2,-420 # ffffffffc0206150 <default_pmm_manager+0xec8>
ffffffffc02042fc:	85a6                	mv	a1,s1
ffffffffc02042fe:	854a                	mv	a0,s2
ffffffffc0204300:	0ce000ef          	jal	ra,ffffffffc02043ce <printfmt>
ffffffffc0204304:	b34d                	j	ffffffffc02040a6 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204306:	00002617          	auipc	a2,0x2
ffffffffc020430a:	e3a60613          	addi	a2,a2,-454 # ffffffffc0206140 <default_pmm_manager+0xeb8>
ffffffffc020430e:	85a6                	mv	a1,s1
ffffffffc0204310:	854a                	mv	a0,s2
ffffffffc0204312:	0bc000ef          	jal	ra,ffffffffc02043ce <printfmt>
ffffffffc0204316:	bb41                	j	ffffffffc02040a6 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204318:	00002417          	auipc	s0,0x2
ffffffffc020431c:	e2040413          	addi	s0,s0,-480 # ffffffffc0206138 <default_pmm_manager+0xeb0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204320:	85e2                	mv	a1,s8
ffffffffc0204322:	8522                	mv	a0,s0
ffffffffc0204324:	e43e                	sd	a5,8(sp)
ffffffffc0204326:	196000ef          	jal	ra,ffffffffc02044bc <strnlen>
ffffffffc020432a:	40ad8dbb          	subw	s11,s11,a0
ffffffffc020432e:	01b05b63          	blez	s11,ffffffffc0204344 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204332:	67a2                	ld	a5,8(sp)
ffffffffc0204334:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204338:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc020433a:	85a6                	mv	a1,s1
ffffffffc020433c:	8552                	mv	a0,s4
ffffffffc020433e:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204340:	fe0d9ce3          	bnez	s11,ffffffffc0204338 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204344:	00044783          	lbu	a5,0(s0)
ffffffffc0204348:	00140a13          	addi	s4,s0,1
ffffffffc020434c:	0007851b          	sext.w	a0,a5
ffffffffc0204350:	d3a5                	beqz	a5,ffffffffc02042b0 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204352:	05e00413          	li	s0,94
ffffffffc0204356:	bf39                	j	ffffffffc0204274 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204358:	000a2403          	lw	s0,0(s4)
ffffffffc020435c:	b7ad                	j	ffffffffc02042c6 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc020435e:	000a6603          	lwu	a2,0(s4)
ffffffffc0204362:	46a1                	li	a3,8
ffffffffc0204364:	8a2e                	mv	s4,a1
ffffffffc0204366:	bdb1                	j	ffffffffc02041c2 <vprintfmt+0x156>
ffffffffc0204368:	000a6603          	lwu	a2,0(s4)
ffffffffc020436c:	46a9                	li	a3,10
ffffffffc020436e:	8a2e                	mv	s4,a1
ffffffffc0204370:	bd89                	j	ffffffffc02041c2 <vprintfmt+0x156>
ffffffffc0204372:	000a6603          	lwu	a2,0(s4)
ffffffffc0204376:	46c1                	li	a3,16
ffffffffc0204378:	8a2e                	mv	s4,a1
ffffffffc020437a:	b5a1                	j	ffffffffc02041c2 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc020437c:	9902                	jalr	s2
ffffffffc020437e:	bf09                	j	ffffffffc0204290 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204380:	85a6                	mv	a1,s1
ffffffffc0204382:	02d00513          	li	a0,45
ffffffffc0204386:	e03e                	sd	a5,0(sp)
ffffffffc0204388:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc020438a:	6782                	ld	a5,0(sp)
ffffffffc020438c:	8a66                	mv	s4,s9
ffffffffc020438e:	40800633          	neg	a2,s0
ffffffffc0204392:	46a9                	li	a3,10
ffffffffc0204394:	b53d                	j	ffffffffc02041c2 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204396:	03b05163          	blez	s11,ffffffffc02043b8 <vprintfmt+0x34c>
ffffffffc020439a:	02d00693          	li	a3,45
ffffffffc020439e:	f6d79de3          	bne	a5,a3,ffffffffc0204318 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02043a2:	00002417          	auipc	s0,0x2
ffffffffc02043a6:	d9640413          	addi	s0,s0,-618 # ffffffffc0206138 <default_pmm_manager+0xeb0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02043aa:	02800793          	li	a5,40
ffffffffc02043ae:	02800513          	li	a0,40
ffffffffc02043b2:	00140a13          	addi	s4,s0,1
ffffffffc02043b6:	bd6d                	j	ffffffffc0204270 <vprintfmt+0x204>
ffffffffc02043b8:	00002a17          	auipc	s4,0x2
ffffffffc02043bc:	d81a0a13          	addi	s4,s4,-639 # ffffffffc0206139 <default_pmm_manager+0xeb1>
ffffffffc02043c0:	02800513          	li	a0,40
ffffffffc02043c4:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02043c8:	05e00413          	li	s0,94
ffffffffc02043cc:	b565                	j	ffffffffc0204274 <vprintfmt+0x208>

ffffffffc02043ce <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02043ce:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc02043d0:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02043d4:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02043d6:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02043d8:	ec06                	sd	ra,24(sp)
ffffffffc02043da:	f83a                	sd	a4,48(sp)
ffffffffc02043dc:	fc3e                	sd	a5,56(sp)
ffffffffc02043de:	e0c2                	sd	a6,64(sp)
ffffffffc02043e0:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc02043e2:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02043e4:	c89ff0ef          	jal	ra,ffffffffc020406c <vprintfmt>
}
ffffffffc02043e8:	60e2                	ld	ra,24(sp)
ffffffffc02043ea:	6161                	addi	sp,sp,80
ffffffffc02043ec:	8082                	ret

ffffffffc02043ee <readline>:
...
ffffffffc02043ee:	715d                	addi	sp,sp,-80
ffffffffc02043f0:	e486                	sd	ra,72(sp)
ffffffffc02043f2:	e0a6                	sd	s1,64(sp)
ffffffffc02043f4:	fc4a                	sd	s2,56(sp)
ffffffffc02043f6:	f84e                	sd	s3,48(sp)
ffffffffc02043f8:	f452                	sd	s4,40(sp)
ffffffffc02043fa:	f056                	sd	s5,32(sp)
ffffffffc02043fc:	ec5a                	sd	s6,24(sp)
ffffffffc02043fe:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc0204400:	c901                	beqz	a0,ffffffffc0204410 <readline+0x22>
ffffffffc0204402:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc0204404:	00002517          	auipc	a0,0x2
ffffffffc0204408:	d4c50513          	addi	a0,a0,-692 # ffffffffc0206150 <default_pmm_manager+0xec8>
ffffffffc020440c:	caffb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
ffffffffc0204410:	4481                	li	s1,0
    while (1) {
        c = getchar();
        if (c < 0) {
            return NULL;
...
ffffffffc0204412:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc0204414:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc0204416:	4aa9                	li	s5,10
ffffffffc0204418:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc020441a:	0000db97          	auipc	s7,0xd
ffffffffc020441e:	cdeb8b93          	addi	s7,s7,-802 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204422:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc0204426:	ccdfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020442a:	00054a63          	bltz	a0,ffffffffc020443e <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020442e:	00a95a63          	bge	s2,a0,ffffffffc0204442 <readline+0x54>
ffffffffc0204432:	029a5263          	bge	s4,s1,ffffffffc0204456 <readline+0x68>
        c = getchar();
ffffffffc0204436:	cbdfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020443a:	fe055ae3          	bgez	a0,ffffffffc020442e <readline+0x40>
            return NULL;
ffffffffc020443e:	4501                	li	a0,0
ffffffffc0204440:	a091                	j	ffffffffc0204484 <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc0204442:	03351463          	bne	a0,s3,ffffffffc020446a <readline+0x7c>
ffffffffc0204446:	e8a9                	bnez	s1,ffffffffc0204498 <readline+0xaa>
        c = getchar();
ffffffffc0204448:	cabfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020444c:	fe0549e3          	bltz	a0,ffffffffc020443e <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204450:	fea959e3          	bge	s2,a0,ffffffffc0204442 <readline+0x54>
ffffffffc0204454:	4481                	li	s1,0
            cputchar(c);
ffffffffc0204456:	e42a                	sd	a0,8(sp)
ffffffffc0204458:	c99fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc020445c:	6522                	ld	a0,8(sp)
ffffffffc020445e:	009b87b3          	add	a5,s7,s1
ffffffffc0204462:	2485                	addiw	s1,s1,1
ffffffffc0204464:	00a78023          	sb	a0,0(a5)
ffffffffc0204468:	bf7d                	j	ffffffffc0204426 <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc020446a:	01550463          	beq	a0,s5,ffffffffc0204472 <readline+0x84>
ffffffffc020446e:	fb651ce3          	bne	a0,s6,ffffffffc0204426 <readline+0x38>
            cputchar(c);
ffffffffc0204472:	c7ffb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc0204476:	0000d517          	auipc	a0,0xd
ffffffffc020447a:	c8250513          	addi	a0,a0,-894 # ffffffffc02110f8 <buf>
ffffffffc020447e:	94aa                	add	s1,s1,a0
ffffffffc0204480:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc0204484:	60a6                	ld	ra,72(sp)
ffffffffc0204486:	6486                	ld	s1,64(sp)
ffffffffc0204488:	7962                	ld	s2,56(sp)
ffffffffc020448a:	79c2                	ld	s3,48(sp)
ffffffffc020448c:	7a22                	ld	s4,40(sp)
ffffffffc020448e:	7a82                	ld	s5,32(sp)
ffffffffc0204490:	6b62                	ld	s6,24(sp)
ffffffffc0204492:	6bc2                	ld	s7,16(sp)
ffffffffc0204494:	6161                	addi	sp,sp,80
ffffffffc0204496:	8082                	ret
            cputchar(c);
ffffffffc0204498:	4521                	li	a0,8
ffffffffc020449a:	c57fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc020449e:	34fd                	addiw	s1,s1,-1
ffffffffc02044a0:	b759                	j	ffffffffc0204426 <readline+0x38>

ffffffffc02044a2 <strlen>:
...
ffffffffc02044a8:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc02044aa:	cb81                	beqz	a5,ffffffffc02044ba <strlen+0x18>
        cnt ++;
ffffffffc02044ac:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc02044ae:	00a707b3          	add	a5,a4,a0
ffffffffc02044b2:	0007c783          	lbu	a5,0(a5)
ffffffffc02044b6:	fbfd                	bnez	a5,ffffffffc02044ac <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc02044bc:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc02044be:	e589                	bnez	a1,ffffffffc02044c8 <strnlen+0xc>
ffffffffc02044c0:	a811                	j	ffffffffc02044d4 <strnlen+0x18>
        cnt ++;
ffffffffc02044c2:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc02044c4:	00f58863          	beq	a1,a5,ffffffffc02044d4 <strnlen+0x18>
ffffffffc02044c8:	00f50733          	add	a4,a0,a5
ffffffffc02044cc:	00074703          	lbu	a4,0(a4)
ffffffffc02044d0:	fb6d                	bnez	a4,ffffffffc02044c2 <strnlen+0x6>
ffffffffc02044d2:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc02044d4:	852e                	mv	a0,a1
ffffffffc02044d6:	8082                	ret

ffffffffc02044d8 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc02044d8:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc02044da:	0005c703          	lbu	a4,0(a1)
ffffffffc02044de:	0785                	addi	a5,a5,1
ffffffffc02044e0:	0585                	addi	a1,a1,1
ffffffffc02044e2:	fee78fa3          	sb	a4,-1(a5)
ffffffffc02044e6:	fb75                	bnez	a4,ffffffffc02044da <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc02044ee:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02044f2:	cb89                	beqz	a5,ffffffffc0204504 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc02044f4:	0505                	addi	a0,a0,1
ffffffffc02044f6:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02044f8:	fee789e3          	beq	a5,a4,ffffffffc02044ea <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc02044fc:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204500:	9d19                	subw	a0,a0,a4
ffffffffc0204502:	8082                	ret
ffffffffc0204504:	4501                	li	a0,0
ffffffffc0204506:	bfed                	j	ffffffffc0204500 <strcmp+0x16>

ffffffffc0204508 <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc0204508:	00054783          	lbu	a5,0(a0)
ffffffffc020450c:	c799                	beqz	a5,ffffffffc020451a <strchr+0x12>
        if (*s == c) {
ffffffffc020450e:	00f58763          	beq	a1,a5,ffffffffc020451c <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204512:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204516:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204518:	fbfd                	bnez	a5,ffffffffc020450e <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc020451e:	ca01                	beqz	a2,ffffffffc020452e <memset+0x10>
ffffffffc0204520:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204522:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204524:	0785                	addi	a5,a5,1
ffffffffc0204526:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc020452a:	fec79de3          	bne	a5,a2,ffffffffc0204524 <memset+0x6>
    }
    return s;
...
ffffffffc0204530 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204530:	ca19                	beqz	a2,ffffffffc0204546 <memcpy+0x16>
ffffffffc0204532:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204534:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204536:	0005c703          	lbu	a4,0(a1)
ffffffffc020453a:	0585                	addi	a1,a1,1
ffffffffc020453c:	0785                	addi	a5,a5,1
ffffffffc020453e:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204542:	fec59ae3          	bne	a1,a2,ffffffffc0204536 <memcpy+0x6>
    }
    return dst;
